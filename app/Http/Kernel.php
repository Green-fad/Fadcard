...
use App\Http\Middleware\CheckWhatsappStoreAnalytics;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'whatsappStoreSubscription' => \App\Http\Middleware\CheckWhatsappStoreSubscription::class,
        ...
        'checkWhatsappStoreAnalyst' => CheckWhatsappStoreAnalytics::class,
    ];
}
