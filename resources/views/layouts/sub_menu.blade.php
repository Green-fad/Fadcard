@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/whatsapp-stores*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/whatsapp-stores') ? 'active' : '' }}"
            href="{{ route('sadmin.whatsapp-stores.index') }}">{{ __('messages.whatsapp_stores.whatsapp_stores') }}</a>
    </li>
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 front-cms-li
    {{ !Request::is(
        'sadmin/front-cms*',
    ...
    {{ !Request::is(
        ...
        ? 'd-none'
        : '' }}">
        <a class="nav-link p-0 pb-3 {{ Request::is('sadmin/email-subscription*') ? 'active' : '' }}"
...
<li
    class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/wp-product-orders*') ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('admin/wp-product-orders*') ? 'active' : '' }}"
        href="{{ route('wp-product-order.index') }}">{{ __('messages.whatsapp_product_order') }}</a>
</li>
<li
...
<li
    class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/whatsapp-store/subscribers/*') ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('admin/whatsapp-store/subscribers/*') ? 'active' : '' }}"
        href="{{ route('whatsapp.stores') }}">{{ __('messages.whatsapp_stores.email_subscription') }}</a>
</li>
<li
