<!-- Newsletter Section -->
<section class="py-20 bg-blue-600" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
...
<!-- Footer -->
<footer class="bg-gray-900 text-white py-8" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            <div class="flex items-center mb-6 md:mb-0">
                <div class="w-auto rounded-lg bg-gradient-to-br flex items-center justify-center text-white shadow-md mr-2 @if (checkFrontLanguageSession() == 'ar') ml-2 mr-0 @endif">
...
<div class="border-t border-gray-800 pt-4">
    <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex flex-wrap justify-center md:justify-end gap-x-6 gap-y-2 @if (checkFrontLanguageSession() == 'ar') md:space-x-reverse @endif">
...
@if (isset($setting['banner_enable']) && $setting['banner_enable'] == 1)
    <section class="flex justify-center" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
