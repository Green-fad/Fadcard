...
<!-- start footer section -->
@if (checkFrontLanguageSession() != 'ar')
    <footer class="pt-4 pb-4 bg-light" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
        <div class="container text-center">
            <div class="row text-center mb-sm-auto mb-0 text-gray-300 fw-5 overflow-hidden">
                ...
                <div class="col-6"> <a href="{{ route('terms.conditions') }}" target="_blank"
                    ...
                    <span class="slash">|</span>
                    <a href="{{ route('refund.cancellation.policy') }}" target="_blank"
                        class="text-decoration-none link-info fs-6">{{ __('messages.vcard.refund_cancellation_policy') }}</a>
                    <span class="slash">|</span>
                    <a href="{{ route('shipping.delivery.policy') }}" target="_blank"
                        class="text-decoration-none link-info fs-6">{{ __('messages.vcard.shipping_delivery_policy') }}</a>
                    <a href="{{ route('imprint.policy') }}" target="_blank"
                        class="text-decoration-none link-info fs-6">{{ __('messages.vcard.imprint_policy') }}</a>
                </div>
            </div>
        </div>
        </div>
...
@if (isset($setting['banner_enable']) && $setting['banner_enable'] == 1)
    <section class="banner-section banner-cookie d-none">
        ...
        <div class="main-banner close-btn bg-transparent">
            <button type="button" class="border-0 bg-transparent"><i
        ...
        <div class="container">
            <div class="row mt-5 pt-4 pb-3">
                ...
                <div class="text-center pt-2">
                    <a href="{{ $setting['banner_url'] }}" class="btn btn-pink act-now " target="blank"
