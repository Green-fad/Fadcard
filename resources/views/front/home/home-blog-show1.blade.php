...
<body>
    ...
    <!-- start hero section -->
    <section class="hero-section bg-primary pt-100 pb-100" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
        <div class="container pt-60  mb-5">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="w-100 mb-3 mt-3 text-white"> {{ $blog->title }}</h2>
                    <div class="text-white fs-18">
                        <span><i class="fas fa-calendar-alt icon-color-bs-purple"></i><span
                            ...
                            class="text-white ms-4 me-4">|</span>
    ...
    <!-- end hero section -->
    <!--start Blogs-section -->
    <section class="about-section overflow-hidden padding-t-100px pb-5" id=""
        @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
        <div class="container p-5 pt-0">
            <div class="row pt-3 pt-lg-0 justify-content-center">
                <div class="col-lg-8 margin-b-80px align-items-center">
