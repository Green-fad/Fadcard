...
@section('content')
                ...
                @foreach ($features as $feature)
                    <div class="col-md-6 mb-40">
                        <div class="feature-card card h-100 flex-row me-md-2">
                            ...
                            <div class="card-body p-0 ps-4 @if (checkFrontLanguageSession() == 'ar') me-4 @endif">
    ...
    <section class="about-section overflow-hidden padding-t-100px py-5" id="frontAboutTabUsTab">
        <div class="container" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
            ...
            <div class="row pt-3 pt-lg-0">
                <div class="col-12 margin-b-80px">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="@if (checkFrontLanguageSession() == 'ar') about-section__about-left-content @else about-section__about-right-content @endif  about-content mt-4 mt-lg-0">
                ...
                <div class="col-12 margin-b-80px">
                    <div class="row align-items-center flex-column-reverse flex-lg-row">
                        <div class="col-xl-6 col-lg-7">
                            <div class="@if (checkFrontLanguageSession() == 'ar') about-section__about-right-content @else about-section__about-left-content @endif about-content mt-4 mt-lg-0">
