...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/faqs/faqs.css') }}">
    <style>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-end">
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                                <ul class="navbar-nav align-items-lg-center">
                                    ...
                                    <li class="nav-item @if ($blogs === null) d-none @endif">
                                        <a class="nav-link nav-link-white"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link nav-link-white"
                                            href="{{ asset('') . '#frontContactUsTab' }}"
                                            data-turbo="false">{{ __('auth.contact') }} </a>
                                    </li>
                                    <li class="nav-item">
                                        <div class="dropdown">
                                            <a class="btn dropdown-toggle nav-link-white" href="#"
                                                role="button" id="dropdownMenuLink" data-bs-toggle="dropdown"
                                                aria-expanded="false" data-turbo="false">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-end">
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                                <ul class="navbar-nav align-items-lg-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link nav-link-white"
                                            href="{{ asset('') . '#frontPricingTab' }}"
                                            data-turbo="false">{{ __('auth.pricing') }}</a>
                                    </li>
                                    <li class="nav-item px-3 @if ($blogs === null) d-none @endif">
                                        <a class="nav-link nav-link-white"
                                            href="{{ route('fornt-blog') }}">{{ __('messages.blog.blogs') }} </a>
                                    </li>
                                    <li class="nav-item @if ($faqs === null) d-none @endif">
