...
@section('content')
    <section class="pt-20 pb-16 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                <h1
                    class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gray-900 leading-tight">
    ...
    @endphp
    <div class="vcard-template-section pt-20 pb-5 relative" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
