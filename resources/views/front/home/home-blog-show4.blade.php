...
@section('content')
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="flex justify-center">
                <div class="w-full lg:w-3/4 xl:w-2/3 mx-auto">
                    ...
                    <div class="flex items-center gap-3 mb-8" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
                        <a href="{{ route('fornt-blog') }}"
                            class="inline-flex items-center text-gray-600 hover:text-blue-600 transition-colors font-medium">
                            <i class='bx bx-arrow-back @if (checkFrontLanguageSession() == 'ar') ml-2 mr-0 @else mr-2 @endif'></i>
                    ...
                    <div class="flex flex-wrap items-center gap-4 mb-6">
                        <div class="inline-flex items-center px-3 py-2 rounded-full bg-blue-100 text-blue-800 text-sm font-medium">
                            <i class='bx bx-calendar @if (checkFrontLanguageSession() == 'ar') ml-2 mr-0 @else mr-2 @endif'></i>
                            {{ $blog->created_at->format('F d, Y') }}
                        </div>
                        <div class="inline-flex items-center px-3 py-2 rounded-full bg-purple-100 text-purple-800 text-sm font-medium">
                            <i class='bx bx-time @if (checkFrontLanguageSession() == 'ar') ml-2 mr-0 @else mr-2 @endif'></i>
    ...
    <main class="container mx-auto px-4 py-5">
        <div class="flex justify-center">
            <div class="w-full lg:w-3/4 xl:w-2/3 mx-auto" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
                <!-- Main Content Card -->
                        ...
                        <div class="flex flex-col md:flex-row items-center md:justify-between">
                            ...
                            <div class="md:w-1/3 flex-shrink-0 flex justify-center md:justify-end">
                                <a href="{{ route('register') }}"
                                    ...
                                    <i class='bx bx-right-arrow-alt @if (checkFrontLanguageSession() == 'ar') mr-2 ml-0 @else ml-2 @endif'></i>
                                </a>
                            </div>
                        </div>
                    </div>
