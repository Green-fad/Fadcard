                    ...
                    <div class="col-lg-8 text-md-end">
                        <div class="d-flex justify-content-md-end justify-content-center flex-wrap">
                            ...
                            <a href="{{ route('refund.cancellation.policy') }}"
                                class="text-black text-decoration-none me-3">{{ __('messages.vcard.refund_cancellation_policy') }}</a>
                            <a href="{{ route('shipping.delivery.policy') }}"
                                class="text-black text-decoration-none me-3">{{ __('messages.vcard.shipping_delivery_policy') }}</a>
                            <a href="{{ route('imprint.policy') }}"
                                class="text-black text-decoration-none">{{ __('messages.vcard.imprint_policy') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center pb-md-4 pb-3 ">
                    ...
                    <div class="col-lg-8 text-md-end">
                        <div class="d-flex justify-content-md-end justify-content-center flex-wrap">
                            ...
                            <a href="{{ route('refund.cancellation.policy') }}"
                                class="text-black text-decoration-none ms-3">{{ __('messages.vcard.refund_cancellation_policy') }}</a>
                            <a href="{{ route('shipping.delivery.policy') }}"
                                class="text-black text-decoration-none ms-3">{{ __('messages.vcard.shipping_delivery_policy') }}</a>
                            <a href="{{ route('imprint.policy') }}"
                                class="text-black text-decoration-none">{{ __('messages.vcard.imprint_policy') }}</a>
                        </div>
                    </div>
