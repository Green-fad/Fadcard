        ...
        <div>
            ...
            @endif
                    ...
                    <div class="businesshour-section px-50 pb-5">
                        <div class="text-center">
                            <h2 class="text-center text-white fs-28 fw-semibold mb-40 section-heading position-relative d-inline-block">{{ __('messages.business.business_hours') }}</h2>
                        </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="businesshour-item d-flex gap-3 align-items-center">
                                        ...
                                        <div class="businesshour-content">
                                            <h3 class="fs-18 fw-6 mb-0 text-break text-primary">{{ __('messages.business.' .
