...
@if ($blog->vcard->template_id == 26)
        ...
        <div class="position-fixed w-100 h-100 top-0 start-0 min-h-800 -z-1">
            <div class="open-vector">
                <div class="main-bg-vector position-relative">
                    <img src="{{ asset('assets/img/vcard26/open.svg') }}" alt="background-img" loading="lazy" class="position-absolute" />
                </div>
            </div>
            <div class="open-vector volume-vector">
                <div class="main-bg-vector position-relative">
                    <img src="{{ asset('assets/img/vcard26/volume-vector.svg') }}" alt="background-img" loading="lazy" class="position-absolute top-50 start-50 translate-middle" />
                </div>
            </div>
            <div class="cart-trolly w-45">
                <img src="{{ asset('assets/img/vcard26/cart-trolly.svg') }}" alt="cart-img" loading="lazy" class="position-relative w-100" />
            </div>
            <div class="phone-bg w-45">
                <img src="{{ asset('assets/img/vcard26/phone-bg.svg') }}" alt="cart-img" loading="lazy" class="w-100" />
            </div>
            <div class="close-bg w-45">
                <img src="{{ asset('assets/img/vcard26/close.svg') }}" alt="cart-img" loading="lazy" class="w-100" />
            </div>
            <div class="headphone-bg w-45">
                <img src="{{ asset('assets/img/vcard26/headphone.svg') }}" alt="cart-img" loading="lazy" class="w-100" />
            </div>
            <div class="credit-card w-45">
                <img src="{{ asset('assets/img/vcard26/purse-svg.svg') }}" alt="cart-img" loading="lazy" class="w-100" />
            </div>
            <div class="van-img w-45">
                <img src="{{ asset('assets/img/vcard26/truck.svg') }}" alt="cart-img" loading="lazy" class="w-100" />
            </div>
        </div>
         <div class="bg-left-animation">
            <img src="{{ asset('assets/img/vcard26/bg-animation.gif') }}" alt="cart-img" loading="lazy" class="w-100" />
        </div>
        <div class="bg-right-animation">
            <img src="{{ asset('assets/img/vcard26/bg2-animation.gif') }}" alt="cart-img" loading="lazy" class="w-100" />
        </div>
@endif

@if ($blog->vcard->template_id == 30)
<div class="background-bg-animation">
    <div class="bg-gif left-gif">
            <img src="{{ asset('assets/img/vcard30/bg.gif') }}" alt="bg-gif" class="w-100">
    </div>
    <div class="bg-gif right-gif">
        <img src="{{ asset('assets/img/vcard30/bg.gif') }}" alt="bg-gif" class="w-100">
    </div>
    <div class="main-wrapper d-flex justify-content-between">
            ...
            <div class="inner-row">
                <div class="line-wrapper justify-content-end">
                    <div class="line">
                        <span class="circle"></span>
                    </div>
                    <div class="line">
...
@if ($blog->vcard->template_id == 19)
    <div class="bg-animation d-flex align-items-center">
        <div class="w-50 h-100 position-relative">
            ...
            <div class="vector-1">
                <img src=" {{ asset('assets/img/vcard19/vector24.png') }}" alt="images" class="w-100" />
            </div>
            <div class="vector-2">
                <img src=" {{ asset('assets/img/vcard19/vector2.png') }}" alt="images" class="w-100" />
            </div>
             <div class="vector-12">
                <img src=" {{ asset('assets/img/vcard19/vector12.png') }}" alt="images" class="w-100" />
            </div>
            <div class="vector-14">
                <img src=" {{ asset('assets/img/vcard19/vector14.png') }}" alt="images" class="w-100" />
            </div>
            <div class="vector-16">
                <img src=" {{ asset('assets/img/vcard19/vector16.png') }}" alt="images" class="w-100" />
            </div>
         ...
         <div class="w-50 h-100 position-relative">
            ...
            <div class="vector-11">
                <div class="position-relative">
                    <img src=" {{ asset('assets/img/vcard19/vector-11.png') }}" alt="images" class="w-100" />
            ...
            <div class="vector-15">
                <img src=" {{ asset('assets/img/vcard19/vector5.png') }}" alt="images" class="w-100" />
            </div>
...
@endif
            ...
            @endif
                ...
                <div id="vcardthirty-effect-bg" class="vcardthirty-effect"></div>
@endif
@if ($blog->vcard->template_id == 32)
<div class="vcard-thirtytwo-effect-bg position-fixed w-100 h-100 top-0 start-0 d-flex">
    <div class="left-img-1 top-0">
    <img src="{{ asset('assets/img/vcard32/light1.png') }}" alt="left-img-1">
    </div>
    <div class="left-img-2 top-0">
    <img src="{{ asset('assets/img/vcard32/light2.png') }}" alt="left-img-1">
    </div>
    <div class="left-img-1 top-0">
    <img src="{{ asset('assets/img/vcard32/light2.png') }}" alt="left-img-1">
    </div>
...
<div class="bg-effect position-fixed top-0 start-0 w-100 h-100">
</div>
@endif


@if ($blog->vcard->template_id == 25)
        <div class="background-animation-card25">
            <div class="left-img  d-flex align-items-center justify-content-between ">
                <div class="hand-img">
                    <img src="{{ asset('assets/img/vcard25/hand-img.png') }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                </div>
                <div class="heart">
                    <img src="{{ asset('assets/img/vcard25/bg-heart.png') }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                </div>
                <div class="hand-img">
                    <img src="{{ asset('assets/img/vcard25/hand-img.png') }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                </div>
        ...
        <div class="background-right-animtion">
            <div class="position-relative">
            <div class="animation-donation">
                    <div class="heart-bg">
                        <img src=" {{ asset('assets/img/vcard25/animation-bg-heart.png') }}" alt="bg-img" class="w-100">
                    </div>
                    <div class="box-img">
                        <img src="{{ asset('assets/img/vcard25/box-images.png') }}" alt="">
                    </div>
                    <div class="main-girl-img">
                        <div class="girl-image">
                            <img src="{{ asset('assets/img/vcard25/girls-img.png') }}" alt="">
                        </div>
                        <div class="girl-head">
                            <img src="{{ asset('assets/img/vcard25/girl-head.png') }}" alt="">
                        </div>
                        <div class="girl-hand">
                            <img src="{{ asset('assets/img/vcard25/girl-hand.png') }}" alt="">
                        </div>
                        <div class="girl-neck">
                            <img src="{{ asset('assets/img/vcard25/girl-neck.png') }}" alt="">
                        </div>
                    </div>
                    <div class="main-img-boy">
                        <div class="boys-img">
                            <img src="{{ asset('assets/img/vcard25/boy-img.png') }}" alt="">
                        </div>
                        <div class="boys-head">
                            <img src="{{ asset('assets/img/vcard25/boy-head.png') }}" alt="">
                        </div>
                        <div class="boys-hand">
                            <img src="{{ asset('assets/img/vcard25/boys-hand.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="vcard-tewntyseven position-fixed top-0 left-0 right-0 bottom-0 w-100 h-100">
    <div class="main-bg-effect position-fixed top-0 left-0 right-0 bottom-0 w-100 h-100">
        <div class="bg-image-half">
        <img src="{{ asset('assets/img/vcard27/bg-main-effect-1.png') }}" alt="Background Image">
    </div>
    <div class="bg-image-half-right">
        <img src="{{ asset('assets/img/vcard27/bg-main-effect-2.png') }}" alt="Background Image">
    </div></div>
  <!-- Top to Bottom Icons -->
  <img src="{{ asset('assets/img/vcard27/effect-img-1.png') }}" class="icon float-down left-0">
  <img src="{{ asset('assets/img/vcard27/effect-img-2.png') }}" class="icon float-down left-10">
  <img src="{{ asset('assets/img/vcard27/effect-img-3.png') }}" class="icon float-down left-20">
  <img src="{{ asset('assets/img/vcard27/effect-img-4.png') }}" class="icon float-down left-30">
  <img src="{{ asset('assets/img/vcard27/effect-img-5.png') }}" class="icon float-down left-40">
  <img src="{{ asset('assets/img/vcard27/effect-img-6.png') }}" class="icon float-down left-50">
  <img src="{{ asset('assets/img/vcard27/effect-img-7.png') }}" class="icon float-down left-60">
  <img src="{{ asset('assets/img/vcard27/effect-img-8.png') }}" class="icon float-down left-70">
  <img src="{{ asset('assets/img/vcard27/effect-img-5.png') }}" class="icon float-down left-80">
  <img src="{{ asset('assets/img/vcard27/effect-img-3.png') }}" class="icon float-down left-90">
  <img src="{{ asset('assets/img/vcard27/effect-img-4.png') }}" class="icon float-down left-100">
  <!-- Bottom to Top Icons -->
  <img src="{{ asset('assets/img/vcard27/effect-img-8.png') }}" class="icon float-up left-5">
  <img src="{{ asset('assets/img/vcard27/effect-img-7.png') }}" class="icon float-up left-15">
  <img src="{{ asset('assets/img/vcard27/effect-img-6.png') }}" class="icon float-up left-25">
  <img src="{{ asset('assets/img/vcard27/effect-img-5.png') }}" class="icon float-up left-35">
  <img src="{{ asset('assets/img/vcard27/effect-img-4.png') }}" class="icon float-up left-45">
  <img src="{{ asset('assets/img/vcard27/effect-img-3.png') }}" class="icon float-up left-55">
  <img src="{{ asset('assets/img/vcard27/effect-img-2.png') }}" class="icon float-up left-65">
  <img src="{{ asset('assets/img/vcard27/effect-img-1.png') }}" class="icon float-up left-75">
  <img src="{{ asset('assets/img/vcard27/effect-img-8.png') }}" class="icon float-up left-85">
  <img src="{{ asset('assets/img/vcard27/effect-img-7.png') }}" class="icon float-up left-95">
    </div>
@endif
@if($blog->vcard->template_id == 23)
<div class="position-fixed top-0 start-0 w-100 h-100">
    <div class="vector-animtion w-100 h-100">
        <img src="{{ asset('assets/img/vcard23/vector1.png') }}" alt="images" class="" />
        <img src="{{ asset('assets/img/vcard23/vector2.png') }}" alt="images" class="" />
        <img src="{{ asset('assets/img/vcard23/vector3.png') }}" alt="images" class="" />
        <img src="{{ asset('assets/img/vcard23/vector4.png') }}" alt="images" class="" />
        <img src="{{ asset('assets/img/vcard23/vector5.png') }}" alt="images" class="" />
    </div>
    <div class="vector-animtion-right w-100 h-100">
        <img src="{{ asset('assets/img/vcard23/vector6.png') }}" alt="images" class="" />
        <img src="{{ asset('assets/img/vcard23/vector7.png') }}" alt="images" class="" />
        <img src="{{ asset('assets/img/vcard23/vector8.png') }}" alt="images" class="" />
        <img src="{{ asset('assets/img/vcard23/vector9.png') }}" alt="images" class="" />
        <img src="{{ asset('assets/img/vcard23/vector10.png') }}" alt="images" class="" />
    </div>
    <div class="bg-effect-1-vcard23">
     <img src="{{ asset('assets/img/vcard23/bg-effect-1-main.gif') }}" alt="images" class="w-100" />
    </div>
    <div class="bg-effect-2-vcard23">
     <img src="{{ asset('assets/img/vcard23/bg-effect-2.gif') }}" alt="images" class="w-100" />
    </div>
</div>
@endif
...
<div class="bg-effect-vcard20 position-fixed top-0 start-0 w-100 h-100">
    ...
    <div class="bg-effect-1 position-absolute bottom-0 start-0">
        <img src="{{ asset('assets/img/vcard20/bg-effect-vcard20-01.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-1 position-absolute bottom-0 end-0">
        <img src="{{ asset('assets/img/vcard20/bg-effect-vcard20-02.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-2 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/shape_2.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-3 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/red_chili.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-4 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/shape_5.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-5 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/red_chili_3.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-6 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/tomato_5.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-7 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/shape_4.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-8 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/shape_3.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-9 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/cherry_1.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-10 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/bg-effect-vcard20-03.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-11 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/bg-effect-vcard20-04.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-12 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/bg-effect-vcard20-05.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-13 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/bg-effect-vcard20-06.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
    <div class="bg-effect-14 bg-effect position-absolute">
        <img src="{{ asset('assets/img/vcard20/bg-effect-vcard20-08.png') }}" loading="lazy" class="w-100 h-100 object-fit-contain" />
    </div>
</div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const images = [
            "{{ asset('assets/img/vcard31/bg-effect-1.svg') }}",
            "{{ asset('assets/img/vcard31/bg-effect-2.svg') }}",
            "{{ asset('assets/img/vcard31/bg-effect-3.svg') }}",
            "{{ asset('assets/img/vcard31/vector-img10.png') }}",
            "{{ asset('assets/img/vcard31/vector-img12.png') }}",
            "{{ asset('assets/img/vcard31/bg-effect-6.png') }}",
            "{{ asset('assets/img/vcard31/bg-effect-7.png') }}",
            "{{ asset('assets/img/vcard31/bg-effect-8.png') }}",
        ];

        const placedPositions = [];
        const minDistance = 200; // Minimum distance between centers
        const imageSize = 80; // Size in px (same as CSS)
        ...
        for (let i = 0; i < 30; i++) {
            ...
            if (attempts >= maxAttempts) {
                console.warn("Could not place all images without overlapping.");
                break;
            }
        }
    });
