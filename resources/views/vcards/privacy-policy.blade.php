...
@endif
    ...
    <div class="background-animation-card25">
        <div class="left-img  d-flex align-items-center justify-content-between ">
            <div class="hand-img">
                <img src="{{ asset('assets/img/vcard25/hand-img.png') }}" class="w-100 h-100 object-fit-cover"
                    loading="lazy" />
            </div>
            <div class="heart">
                <img src="{{ asset('assets/img/vcard25/bg-heart.png') }}" class="w-100 h-100 object-fit-cover"
                    loading="lazy" />
            </div>
            <div class="hand-img">
                <img src="{{ asset('assets/img/vcard25/hand-img.png') }}" class="w-100 h-100 object-fit-cover"
