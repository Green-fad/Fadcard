...
<body>
    ...
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-fifteen main-content mx-auto w-100 overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="profile-section px-30 pt-30 position-relative">
                <div
                    class="position-absolute top-0 @if (getLanguage($vcard->default_language) == 'Arabic') start-0 main-vector-1 @else end-0 @endif">
            ...
            <div class="social-media  d-flex  flex-wrap justify-content-center pt-40 px-30 position-relative">
                <div class="position-absolute vector-all vector-bg-1">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-1.png') }}" class="w-100" alt="images" />
                </div>
            ...
            <div class="contact-section pt-50 position-relative">
                <div class="position-absolute vector-all vector-bg-2 text-end">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-2.png') }}" class="w-100" alt="images" />
                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="mailto:{{ $vcard->email }}" class="text-dark text-center fw-5">{{
                                        $vcard->email
                                        }}</a>
                                </div>
                            </div>
                            ...
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="tel:+{{ $vcard->region_code }} {{ $vcard->phone }}"
                                        class="text-dark text-center fw-5" dir="ltr">+{{ $vcard->region_code }}
                                        {{ $vcard->phone }}</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                        class="text-dark text-center fw-5" dir="ltr">+{{
            ...
            <div class="our-services-section pt-50 position-relative">
                <div class="position-absolute vector-all vector-bg-3">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-3.png') }}" class="w-100" alt="images" />
                </div>
                <div class="section-heading">
                    <h2>
            ...
            <div class="qr-code-section position-relative pt-50">
                <div class="position-absolute vector-all vector-bg-4 text-end">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-4.png') }}" class="w-100" alt="images" />
                </div>
                <div class="section-heading">
            ...
            <div class="gallery-section pt-50 position-relative">
                <div class="position-absolute vector-all vector-bg-5">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-5.png') }}" class="w-100" alt="images" />
                </div>
                <div class="section-heading">
                    <h2>{{
            ...
            <div class="product-section pt-50 position-relative">
                <div class="position-absolute vector-all vector-bg-6 text-end">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-6.png') }}" class="w-100" alt="images" />
                </div>
                <div class="section-heading">
                    <h2>{{
                                    ...
                                    <div class="product-card card">
                                        ...
                                        <div
                                            ...
                                            <div class="product-amount">
                                                ...
                                                <span>{{ getUserCurrencyIcon($vcard->user->id) . ' ' .
                                                    $product->price
                                                    }}</span>
                                                @endif
                                            </div>
            ...
            <div class="testimonial-section pt-50 position-relative">
                <div class="position-absolute vector-all vector-bg-7">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-7.png') }}" class="w-100" alt="images" />
                </div>
                <div class="section-heading">
                    <h2>
                ...
                <div class="px-20">
                    <div class="testimonial-slider">
                        ...
                        <div>
                            <div class="testimonial-card p-0" @if (getLanguage($vcard->default_language) ==
                                'Arabic')
                                dir="rtl" @endif>
                                <div class="card-body text-center position-relative">
                                    <div class="quote-img">
                                        <img src="{{ asset('assets/img/vcard15/quote-img.svg') }}" class="h-100"
                                            loading="lazy" />
                                    </div>
                                    <div class="text-center">
                                        <p
                                ...
                                <div
                                    ...
                                    <h6 class="name mb-0 text-decoration-underline">{{ ucwords($testimonial->name)
                                        }}
                                    </h6>
                                </div>
                            </div>
            ...
            <div class="insta-feed-section pt-50 position-relative">
                <div class="position-absolute vector-all vector-bg-8 text-end">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-8.png') }}" class="w-100" alt="images" />
                </div>
                <div class="section-heading">
                    <h2>
                ...
                <div class="blog-section pt-50 position-relative">
                    <div class="position-absolute vector-all vector-bg-9">
                        <img src="{{ asset('assets/img/vcard15/vector-bg-9.png') }}" class="w-100" alt="images" />
                    </div>
                    <div class="section-heading">
                        <h2>
                            ...
                            <div>
                                <div class="blog-card card">
                                    ...
                                    <div class="card-body text-start">
                                        ...
                                        <div class="text-end mt-1  @if (getLanguage($vcard->
                                                default_language) ==
                ...
                <div class="business-hour-section pt-50 position-relative">
                    <div class="position-absolute vector-all vector-bg-10 text-end">
                        <img src="{{ asset('assets/img/vcard15/vector-bg-10.png') }}" class="w-100" alt="images" />
                    </div>
                    <div class="section-heading">
                        <h2>
                    ...
                    <div class="px-30">
                        <div class="row justify-content-center" @if (getLanguage($vcard->default_language) ==
                            ...
                            <div class="col-sm-6">
                                <div class="business-hour-card d-flex gap-2 align-items-center mb-3">
                                    ...
                                    <div class="d-flex flex-column align-items-start">
                                        <span class="fs-14 text-gray lh-1 fw-5"> {{ __('messages.business.' .
                                            \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}</span>
                                        <span class="fs-16 fw-5">{{ $dayTime ?? __('messages.common.closed')
                                            }}</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="appointment-section pt-40 position-relative">
                    <div class="position-absolute vector-all vector-bg-11">
                        <img src="{{ asset('assets/img/vcard15/vector-bg-11.png') }}" class="w-100" alt="images" />
                    </div>
                    <div class="section-heading">
                        <h2>
                    ...
                    <div class="px-30">
                        <div class="appointment-card p-3">
                            <div class="row d-flex align-items-center justify-content-center">
                                <div class="col-12" @if (getLanguage($vcard->default_language) == 'Arabic')
                                    dir="rtl"
                                    @endif>
                                    {{ Form::text('date', null, ['class' => 'date appointment-input', 'placeholder'
                                    =>
                                    __('messages.form.pick_date'), 'id' => 'pickUpDate']) }}
                                </div>
                    ...
                    <div class="iframe-section pt-50 position-relative overflow-hidden">
                        <div class="position-absolute vector-all vector-bg-12 text-end">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-12.png') }}" class="w-100" alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>
                                ...
                                <div>
                                    <div class="iframe-card">
                                        <iframe src="{{ $iframe->url }}" frameborder="0"
                                            ...
                                            allowfullscreen width="100%" height="320" class="w-100" loading="lazy">
                                        </iframe>
                                    </div>
                                </div>
                                @endforeach
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 mt-2">
                                            <div class="wrapper-file-input">
                                                <div class="input-box" id="fileInputTrigger">
                                                    <h4> <i class="fa-solid fa-upload me-2"></i>{{
                                                        __('messages.choose_file') }}
                                                    </h4> <input type="file" id="attachment" name="attachment" hidden
                                                        multiple />
                                                </div> <small class="text-gray fw-5">{{
                                        ...
                                        <div class="col-12 mt-1">
                                            ...
                                            <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                <span class="text-dark">{{ __('messages.vcard.agree_to_our')
                                                    }}</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-underline link-info text-primary fw-5">{!!
                            ...
                            <div class="contact-form" dir="rtl">
                                <form action="" id="enquiryForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <textarea class="form-control text-start h-100" name="message"
                                                placeholder="{{ __('messages.form.type_message') }}"
                                                rows="3"></textarea>
                                        </div>
                                        @if (isset($inquiry) && $inquiry == 1)
                                        <div class="mb-3 mt-2">
                                            <div class="wrapper-file-input">
                                                <div class="input-box" id="fileInputTrigger">
                                                    <h4> <i class="fa-solid fa-upload ms-2"></i>{{
                                                        __('messages.choose_file') }}
                                                    </h4> <input type="file" id="attachment" name="attachment" hidden
                                                        multiple />
                                                </div> <small class="text-gray fw-5">{{
                    ...
                    <div class="create-vcard-section pt-50 position-relative bg-white">
                        <div class="position-absolute vector-all vector-bg-14 text-end">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-14.png') }}" class="w-100" alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>
                                ...
                                <div class="vcard-link-card card">
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        <a href="{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}"
                                            class="fw-6 text-primary link-text">{{ route('register',
                                            ['referral-code' =>
                    ...
                    <div class="main-section px-30 pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-15">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-15.png') }}" class="w-100" alt="images" />
                        </div>
                        <div class="iframe-card-box">
                            <div class="map-location d-flex gap-2 mb-3 align-items-center" @if (getLanguage($vcard->
                                default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="main-section px-30 pt-50 position-relative">
                        ...
                        <div class="iframe-card-box">
                            <div class="map-location d-flex gap-2 mb-2 align-items-center" @if (getLanguage($vcard->
                                default_language) == 'Arabic') dir="rtl" @endif>
                                <div class="location-icon d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/img/vcard15/location.svg') }}" />
                                </div>
                    ...
                    <div
                        ...
                        <div class="fixed-btn-section">
                            ...
                            <div
                                class="bars-btn salon-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="" method="post" id="newsLatterForm">
                                ...
                                <div
                                    ...
                                    <button class="btn ms-1" type="submit" id="email-send">{{
            ...
            <div id="vcard15-shareModel" class="modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl"
                        @endif>
                        <div class="">
