        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
           ...
           {{--
            ...
            <div class="profile-section pt-40 position-relative">
                        <div class="position-absolute  w-100 h-100 main-bg-vector @if (getLanguage($vcard->default_language) == 'Arabic') start-0 @else end-0  @endif">
                            <img src="{{ asset('assets/img/vcard27/main-vector-bg.png') }}" alt="images" class="w-100 h-100 object-fit-cover" />
                        </div>
                <div class="px-30 position-relative">
                    <div class="card d-flex flex-sm-row align-items-center position-relative gap-3 gap-sm-4"  @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class="card-body p-0 text-sm-start text-center">
                            <div class="profile-name">
                                ...
                                <p class="fs-18 text-decoration-underline text-primary-200 mb-0">{{ ucwords($vcard->company) }}</p>
                ...
                @if (checkFeature('social_links') && getSocialLink($vcard))
                 <div class="social-media pt-40 d-flex flex-wrap justify-content-center px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-2">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-1.png') }}" alt="images" class="w-100" />
                        </div>

                        <div
                            class="social-icons d-flex justify-content-center flex-wrap gap-3 w-100">
                ...
                @if(!empty($vcard->email) || !empty($vcard->alternative_email || !empty($vcard->phone) || !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                    <div class="contact-section pt-50 px-30 position-relative">
                                <div class="position-absolute vector-all vector-bg-4 text-end">
                                    <img src="{{ asset('assets/img/vcard27/vector-bg-2.png') }}" alt="images" class="w-100" />
                                </div>
                        {{-- contact section --}}
                        @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="contact-box d-flex align-items-center">
                                                    <div
                                                        ...
                                                        <img src="{{ asset('assets/img/vcard27/email.svg') }}" alt="" />
                                                    </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="contact-box d-flex align-items-center">
                                                    <div
                                                        class="contact-icon d-flex justify-content-center align-items-center">
                                                        <img src="{{ asset('assets/img/vcard27/phone.svg') }}" alt="" />
                                                    </div>
                                                    <div class="contact-desc">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="contact-box d-flex align-items-center">
                                                    <div
                                                        class="contact-icon d-flex justify-content-center align-items-center">
                                                        <img src="{{ asset('assets/img/vcard27/dob.svg') }}" alt="" />
                                                    </div>
                                                    <div class="contact-desc">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-5">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-3.png') }}" alt="images" class="w-100" />
                        </div>
                        <div class="section-heading">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-6 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-4.png') }}" alt="images" class="w-100" />
                        </div>
                    ...
                    <div class="appointment-section pt-50 position-relative">
                       <div class="appointment-main px-30">
                        <div class="position-absolute vector-all vector-bg-7">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-5.png') }}" alt="images" class="w-100" />
                        </div>
                        <div class="section-heading">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-bg-8 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-6.png') }}" alt="images" class="w-100" />
                        </div>
                            ...
                            @foreach ($vcard->products as $product)
                                <div class="">
                                    <div class="product-card card">
                                        ...
                                        <div class="product-desc card-body p-3 text-center position-relative z-index-1">
                                                ...
                                                <p class="amount mb-0 fw-6 text-primary">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="text-primary">{{ $product->currency->currency_icon }} {{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-9">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-7.png') }}" alt="images" class="w-100" />
                        </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                ...
                <div class="qr-code-main px-30">
                    <div class="position-absolute vector-all vector-bg-10 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-8.png') }}" alt="images" class="w-100" />
                        </div>
                    <div class="section-heading">
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-11">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-9.png') }}" alt="images" class="w-100" />
                        </div>
                        <div class="section-heading px-30">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-bg-12 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-10.png') }}" alt="images" class="w-100" />
                        </div>
                        <div class="section-heading px-3">
                        ...
                        <div class="blog-slider">
                            @foreach ($vcard->blogs as $blog)
                                ...
                                <div>
                                    ...
                                    <a href="{{ $vcardBlogUrl  }}" class="text-white read-more d-inline-flex align-items-center justify-content-end gap-2" tabindex="-1">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-13">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-11.png') }}" alt="images" class="w-100" />
                        </div>
                        <div class="section-heading">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div class="business-hour" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                            ...
                                            <div class="fs-16 text-primary text-center lh-1">{{ $dayTime ?? __('messages.common.closed') }}</div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-bg-14 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-12.png') }}" alt="images" class="w-100" />
                        </div>
                        <div class="text-center">
                            <div class="section-heading">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-50 px-30">
                    <div class="position-absolute vector-all vector-bg-15">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-13.png') }}" alt="images" class="w-100" />
                        </div>
                    <div class="section-heading">
                        ...
                        <div class="contact-form" dir="rtl">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @endif
                                    <div class="col-12 text-center">
                                        <button class="send-btn btn btn-secondary send-msg-btn"
                                            type="submit">
                                            {{ __('messages.contact_us.send_message') }}
                                        </button>
                                    </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section px-30 pt-50 position-relative text-end">
                    <div class="position-absolute vector-all vector-bg-16">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-14.png') }}" alt="images" class="w-100" />
                        </div>
                    <div class="section-heading">
                    ...
                    <div class="">
                        <div class="vcard-link-card card">
                            <div class="d-flex align-items-center justify-content-center gap-2" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
               ...
               <div class="pt-50 px-30 position-relative">
                <div class="position-absolute vector-all vector-bg-1">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-15.png') }}" alt="images" class="w-100" />
                        </div>
                    <div class="map-section">
                        <div class="map-location d-flex gap-3 px-2 align-items-center pb-3 pt-2" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                ...
                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div>
                        <a class="text-decoration-none text-dark cursor-pointer terms-policies-btn"
                            href="{{ $vcardPrivacyAndTerm }}"><small class="fw-5">{!! __('messages.vcard.term_policy') !!}</small></a>
                    </div>
                @endif
            </div>
            {{-- sticky btn --}}
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($userSetting['hide_stickybar']))
                        <div
                            class="bars-btn bg-primary pet-shop-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
