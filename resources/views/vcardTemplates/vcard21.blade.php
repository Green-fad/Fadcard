    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            @if (isset($enable_pwa) && $enable_pwa == 1 && !isiOSDevice())
                    ...
                    <div class="pwa-support-content d-flex align-items-center justify-content-center"  @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div>
                            ...
                            <div class="text-end d-flex gap-2">
                                <button id="installPwaBtn"
                                    class="pwa-install-button w-50 mb-1 btn btn-gradient">{{ __('messages.pwa.install') }} </button>
                                <button
                ...
                <div class="card-wrapper">
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div class="d-flex flex-column">
                            <h1 class="text-center text-primary support_heading mx-auto">{{ $banners->title }}</h1>
            ...
            <div class="profile-section position-relative pt-40 px-30">
                <div class="card-wrapper">
                    <div class="profile-card card overflow-hidden flex-sm-row flex-column align-items-center position-relative gap-4 justify-content-sm-start" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div class="position-absolute bottom-0 main-bg-vcard21 @if (getLanguage($vcard->default_language) == 'Arabic') start-0 @else end-0 @endif">
                            <img src="{{ asset('assets/img/vcard21/vcard21-main-bg.png') }}" alt="vector-img" class="w-100 h-100 object-fit-cover"/>
                            </div>
                        <div class="card-img d-flex justify-content-center align-items-center position-relative">
                            <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover main-img" loading="lazy" />
                        </div>
                        <div class="card-body p-0 position-relative text-center  @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @else text-sm-start @endif">
                            <div class="profile-name">
                                ...
                                <p class="fs-18 text-primary text-decoration-underline mb-0">{{ ucwords($vcard->company) }}</p>
                ...
                <div class="social-media pt-40 px-30 d-flex flex-wrap justify-content-sm-start justify-content-center position-relative">
                    <div class="position-absolute vector-1 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-1.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                    <div
            ...
            @endphp
                @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                    <div class="contact-section position-relative px-30 pt-50">
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-2.png') }}" alt="vector-img" class="w-100"/>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-3.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                        <div class="section-heading text-center mb-40">
                                        ...
                                        <div>
                                            ...
                                            <div class="card-img">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p
                                                        class="card-text description-text text-black text-center {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-4.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                        <div class="section-heading text-center mb-40">
                    ...
                    <div class="appointment-box">
                        <div class="appointment">
                            <div class="row justify-content-center">
                                <div class="col-12 ">
                                    <div class="position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 px-30 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-5.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-6.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
                                   ...
                                   <div class="testimonial-box">
                                    <div class="testimonial-card">
                                        <div class="quote-img left-img">
                                            <img src="{{asset('assets/img/vcard21/quote-left.svg')}}" loading="lazy"/>
                                            </div>
                                            <div class="quote-img right-img">
                                            <img src="{{asset('assets/img/vcard21/quote-right.svg')}}" loading="lazy"/>
                                            </div>
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-7.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
                                ...
                                <div>
                                    ...
                                    <div class="product-card card">
                                        ...
                                        <div class=" product-desc card-body text-center">
                                                ...
                                                <div class="product-amount text-primary text-decoration-underline fw-bold text-center">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="fw-6 text-primary text-decoration-underline">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                                    @elseif($product->price)
                                                        <span
                                                            class="fw-6 text-primary text-decoration-underline">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                    @endif
                                                </div>
                                        </div>
                                    </div>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                ...
                <div class="instagram-feed-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-8 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-8.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                    <div>
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-9.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0 d-inline-block">
                                    ...
                                    <div class="blog-card card"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center justify-content-end mt-2">
                                                <a href="{{ $vcardBlogUrl }}" class="read-more text-primary d-inline-flex align-items-center justify-content-end gap-2 fs-14" tabindex="0">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative"
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-10.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-md-6">
                                        <div class="business-hour">
                                           <div class="business-box d-flex  align-items-center gap-2">
                                            <div class="business-hour-icon text-gradient">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-calendar-time text-primary" width="24" height="24"
                                           ...
                                           <div>
                                                <div class="text-primary fs-14">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}:</div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-11 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-11.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-dark mb-0">
                    ...
                    <div class="card-wrapper">
                    <div class="qr-code d-flex flex-sm-row flex-column gap-3 align-items-center" @if (getLanguage($vcard-> default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-13.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 pt-50 position-relative">
                    <div class="position-absolute vector-13 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-12.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-dark mb-0">
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                            ...
                                            <div class="wrapper-file-input">
                                                <div class="input-box" id="fileInputTrigger">
                                                    <h4> <i
                                                        ...
                                                        hidden multiple />
                                                </div> <small class="text-black">{{ __('messages.file_supported') }}</small>
                                            </div>
                                    ...
                                    <div class="col-12 text-center">
                                        <button class="contact-btn send-btn btn  fw-5 btn-primary"
                                            type="submit">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-14 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-14.png') }}" alt="vector-img" class="w-100"/>
                        </div>
                    ...
                    <div class="vcard-link-card card">
                        <div class="d-flex justify-content-center align-items-center gap-3" @if (getLanguage($vcard->
                ...
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                  <div class="px-30 pt-50 position-relative">
                    <div class="position-absolute vector-15 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-15.png') }}" alt="vector-img" class="w-100"/>
                        </div>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn social-media-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
