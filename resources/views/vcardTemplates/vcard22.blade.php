    ...
    <div class="container p-0 vcard22-main">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section pt-40 pb-40 px-30 position-relative">
                ...
                <div
                    class="card d-flex flex-sm-row gap-3 gap-sm-4 align-items-center">
                    <div class="card-img">
                    ...
                    <div class="card-body text-sm-start text-center profile-details p-0 position-relative">
                        <div class="profile-name">
                            <h2 class="text-primary mb-0 fs-24  @if (getLanguage($vcard->default_language) == 'Arabic') d-flex gap-2  flex-row-reverse @endif">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                        ...
                        <div class="contact-section pt-40 pb-40 px-30 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc w-100 text-center">
                                            <a href="tel:{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                    class="contact-desc w-100 text-center fw-5" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc w-100 text-center">
                                            <a href="tel:{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                    class="contact-desc w-100 text-center fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                        ...
                                        @foreach ($vcard->services as $service)
                                            <div>
                                                ...
                                                <div class="position-absolute w-100 bottom-0 start-0 service-wave-img">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 295 151" fill="currentColor">
                                                ...
                                                <div class="text-center services-desc card-body px-0 pb-0 position-relative">
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                ...
                                                <div class="position-absolute w-100 bottom-0 start-0 service-wave-img">
                                                    ...
                                                    <div>
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                            class="text-decoration-none card-img {{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                            target="{{ $service->service_url ? '_blank' : '' }}">
                                                        <img src="{{ $service->service_icon }}" class="w-100 h-100 object-fit-cover"
                                                            loading="lazy" />
                                                        </a>
                                                    </div>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-40  px-30">
                        ...
                        <div class="appointment pb-0 p-3"@if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="appointment-slots-section">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="appointmentAdd btn w-70 d-none" id="appointment-btn"
                                        data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}">
                            ...
                            <div class="testimonial-slider">
                                @foreach ($vcard->testimonials as $testimonial)
                                    <div class="">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 610 214" fill="currentColor">
                                            ...
                                            <div class="card-body text-start p-0 position-relative">
                                                ...
                                                <div class="text-end d-flex justify-content-end align-items-center">
                                                    <div class="quote-img">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="45" viewBox="0 0 60 45" fill="CurrentColor">
                    ...
                    <div class="blog-section pt-40 px-20">
                        ...
                        <div class="blog-slider">
                            @foreach ($vcard->blogs as $blog)
                                ...
                                ?>
                                <div>
                                    <div class="blog-card overflow-hidden" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                        <div class="card-img">
                                            <a href="{{ $vcardBlogUrl  }}">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-40 px-30">
                    ...
                    <div class="qr-code mx-auto  position-relative">
                        ...
                        <div class="d-flex qr-code-box flex-sm-row flex-column align-items-center" @if (getLanguage($vcard->
                            ...
                            <div
                                class=" text-center @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @else text-sm-start @endif">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-40 px-30">
                    ...
                    <div class="vcard-link-card card">
                            <div class="d-flex align-items-center gap-2 gap-sm-3 justify-content-center" @if (getLanguage($vcard->
                                default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_url && isset($url[5]))
                    ...
                    <div class="map-location d-flex gap-3 align-items-center" @if (getLanguage($vcard->
                        default_language) == 'Arabic') dir="rtl" @endif>
