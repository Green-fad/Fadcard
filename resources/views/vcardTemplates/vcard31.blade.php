        ...
        <div
                ...
                <div class="pwa-support d-flex align-items-center justify-content-center">
                    <div>
                        ...
                        <div class="text-end d-flex">
                            <button id="installPwaBtn" class="pwa-install-button btn-primary w-50 mb-1 btn">{{
            ...
            <div class="support-banner d-flex align-items-center justify-content-center">
                ...
                <div class="">
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ $banners->url }}" class="act-now btn-primary" target="_blank" data-turbo="false">{{
            ...
            <div class="profile-section pt-50 px-30 position-relative">
                ...
                <div class="card d-flex flex-column flex-sm-row align-items-center gap-3 gap-sm-4">
                    ...
                    <div class="card-body p-0">
                        <div class="profile-name text-center @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @else text-sm-start @endif">
                            <h3 class=" mb-0 fs-28">
                            ...
                            <p class="text-primary mb-1 fs-16 company-name d-inline-block">{{ ucwords($vcard->company)
                                }}</p>
            ...
            <div class="pt-50">
                <div class="contact-section pt-40 pb-40 px-30 bg-light position-relative">
                    <div class="vector-all-right position-absolute">
                        <img src="{{ asset('assets/img/vcard31/vector-all-img.png') }}" alt="bg-img" class="w-100 h-100 object-fit-cover" />
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box d-flex align-items-center">
                                ...
                                <div class="contact-desc">
                                    <a href="mailto:{{ $vcard->email }}" class="text-white fs-14 fw-5 word-wrap">{{
                                        $vcard->email }}</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="service-card h-100 d-flex flex-column">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <p class="mb-0 description-text text-gray-100 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                            {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12">
                                ...
                                <div class=text-center d-flex justify-content-center>
                                    <button class="appointmentAdd btn btn-primary w-100 position-relative d-none">
                                ...
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="product-desc text-center desc-div">
                                        ...
                                        <h4 class="text-center text-primary mb-0">
                                            ...
                                            <span class="fs-18 fw-6 text-primary product-amount">{{
                        ...
                        <div>
                            <div class="testimonial-card card">
                                ...
                                <div class="card-body p-0 text-center">
                                    <h3 class="text-white text-decoration-underline">{{ ucwords($testimonial->name) }}
                                    </h3>
                                    <div class="quote-img text-center mb-3">
                                        <img src="{{ asset('assets/img/vcard31/quote-img.svg') }}" class="mx-auto" />
                                    </div>
                                    <p
                        ...
                        <div class="blog-card">
                            ...
                            <div class="card-body">
                                <div class="text-start">
                                    ...
                                    <div class="mt-1 d-flex align-items-center justify-content-end" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                        <a href="{{ $vcardBlogUrl  }}"
            ...
            <div class="business-hour-section pt-50 position-relative">
                ...
                <div class="vector-all-right position-absolute">
                    ...
                    <div @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl"
                        @endif>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-sm-6 px-sm-2 mb-3">
                                <div class="hour d-flex align-items-center">
                                    ...
                                    class="icon icon-tabler icon-tabler-calendar-time text-primary" width="22" height="22"
                                    ...
                                    <div>
                                <div class="fs-14 text-gray-100">{{ __('messages.business.' .
                                        \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                        :</div>
                                        <div class="text-white fs-14">{{ $dayTime ?? __('messages.common.closed') }}</div>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                <div class="wrapper-file-input">
                                    ...
                                    </div> <small class="text-gray-100">{{ __('messages.file_supported') }}</small>
                                </div>
                            ...
                            <div class="col-12 mb-4 d-flex gap-2">
                                ...
                                <label class="fs-14 form-check-label" for="privacyPolicyCheckbox">
                                    <span class="text-gray-100">{{ __('messages.vcard.agree_to_our') }}</span>
                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                        class="link-info fs-14 fw-5 text-decoration-underline text-white">{!!
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-4 d-flex gap-2">
                                ...
                                <label class="form-check-label" for="privacyPolicyCheckbox">
                                    <span class="text-gray-100">{{ __('messages.vcard.agree_to_our') }}</span>
                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                        class="text-decoration-underline text-white fs-14 fw-5 link-info">{!!
                                        __('messages.vcard.term_and_condition') !!}</a>
                                    <span class="text-gray-100">&</span>
                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                        class="text-decoration-underline text-white fs-14 fw-5 link-info">{{
                ...
                <div class="vector-img img-15">
                    ...
                    <div class="section-heading">
                        ...
                        <div class="vcard-link-card card">
                            <div class="d-flex align-items-center gap-3 justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                <a href="{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}"
                                    class="text-primary link-text fw-normal">{{ route('register', ['referral-code' =>
          ...
          <div class="map-section">
            ...
            <div class="btn-section cursor-pointer  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    ...
                    <div
                        class="bars-btn handyman-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                    ...
                    <div class="sub-btn d-none">
                        <div
                            ...
                            @endif
                            @if (empty($vcard->hide_stickybar))
                            <div class="{{ isset($vcard->whatsapp_share) ? 'vcard31-btn-group' : 'stickyIcon' }}">
                                <button type="button"
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" id="newsLatterForm">
                        ...
                        <div class="mb-1 mt-4 d-flex gap-1 justify-content-center align-items-center email-input">
                            <div class="w-100">
                                <input type="email" class="form-control bg-dark border-0 text-lightemail-input w-100"
