...
<body>
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            {{-- profile seciton --}}
            <div class="profile-section px-30 pt-50">
                <div class="card d-flex flex-sm-row align-items-center gap-3 position-relative">
                    ...
                    <div class="card-body p-0 w-50">
                        <div class="profile-name">
                            <h2 class="mb-0 fs-24 fw-6 text-white">
                                {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                @if ($vcard->is_verified)
                                    <i class="verification-icon bi-patch-check-fill text-secondary"></i>
                                @endif
                            </h2>
                            <p class="fs-16 mb-0 text-secondary">{{ ucwords($vcard->company) }}</p>
                            <p class="fs-14 mb-0 text-white">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-14 mb-0 text-white">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="desc text-center pt-40">
                ...
                <div class="social-media d-flex justify-content-center pt-40 position-relative">
                    ...
                    <img src="{{ asset('assets/img/vcard23/vector7.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                </div>
                        <div
            ...
            !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                <div class="contact-section pt-50 px-30 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                <div class="bg-vector vector-3 position-absolute left-10">
                    <img src="{{ asset('assets/img/vcard23/vector3.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                </div>
                    <div class="section-heading text-center">
                        <h2 class="text-black text-center mb-0">{{ __('messages.contact_us.contact') }}</h2>
                        <span></span>
                    </div>
                    <div class="row">
                        @if ($vcard->email)
                                ...
                                <div class="contact-bg">
                                    <div class="contact-box">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard23/email.svg') }}" loading="lazy" />
                                        </div>
                        ...
                        @if ($vcard->phone)
                            <div class="col-sm-6">
                                <div class="contact-bg mail-3">
                                    <div class="contact-box">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard23/phone.svg') }}" loading="lazy" />
                                        </div>
                                        <div class="contact-desc text-center">
                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="text-white fs-14 fw-5 text-center" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-desc text-center">
                                            <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                class="text-white fs-14 fw-5 text-center" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if ($vcard->dob)
                            <div class="col-sm-6">
                                <div class="contact-bg mail-2">
                                    <div class="contact-box">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard23/dob.svg') }}" loading="lazy" />
                                        </div>
                                        <div class="contact-desc text-center">
                                            <p class="mb-0 text-white fs-14 fw-5 text-center"> {{ $vcard->dob }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if ($vcard->location)
                            <div class="col-sm-6">
                                <div class="contact-bg mail-3">
                                    <div class="contact-box">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard23/location.svg') }}" loading="lazy" />
                                        </div>
                                        <div class="contact-desc text-center">
                                            <p class="text-white mb-0 fs-14 fw-5 text-center">{!! ucwords($vcard->location) !!}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50">
                        <div class="bg-vector vector-4 position-absolute right-10">
                            <img src="{{ asset('assets/img/vcard23/vector16.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.vcard.our_service') }}</h2>
                            <span></span>
                        </div>
                        <div class="services">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30">
                        <div class="bg-vector vector-5 position-absolute left-10">
                            <img src="{{ asset('assets/img/vcard23/vector8.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.make_appointments') }}</h2>
                            <span></span>
                        </div>
                        <div class="appointment-bg p-3">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 px-20 position-relative">
                        <div class="bg-vector vector-6 position-absolute right-10">
                            <img src="{{ asset('assets/img/vcard23/vector15.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.plan.gallery') }}</h2>
                            <span></span>
                        </div>
                        <div class="position-relative">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        <div class="bg-vector vector-7 position-absolute left-10">
                            <img src="{{ asset('assets/img/vcard23/vector4.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="bg-vector vector-7 position-absolute left-10">
                            <img src="{{ asset('assets/img/vcard23/vector13.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.plan.testimonials') }}</h2>
                            <span></span>
                        </div>
                                ...
                                <div>
                                    <div class="testimonial-card card">
                                        <div class="testimonial-profile-img">
                                            <img src="{{ $testimonial->image_url }}" class="w-100 h-100 object-fit-cover rounded-circle" loading="lazy" />
                                        </div>
                                        <div class="card-body p-0 pt-5 position-relative">
                                                <div class="position-absolute quote-img">
                                                    <svg width="28" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M7 10.4142L2.70711 14.7071L1.29289 13.2929L5 9.58579V9L1 9V2H7V10.4142Z" fill="#fff"></path> <path d="M9 9L13 9V9.58579L9.29289 13.2929L10.7071 14.7071L15 10.4142L15 2H9L9 9Z" fill="#fff"></path> </g></svg>
                                                </div>
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50">
                        <div class="bg-vector vector-8 position-absolute right-10">
                            <img src="{{ asset('assets/img/vcard23/vector9.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.plan.products') }}</h2>
                            <span></span>
                        </div>
                        <div class="">
                                ...
                                @foreach ($vcard->products as $product)
                                    <div>
                                        <div class="product-card card overflow-hidden">
                                            ...
                                            <div
                                                class="product-desc card-body p-3 text-center position-relative">
                                                <div class="">
                                                ...
                                                <h4 class="text-center mb-0 product-amount">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="fw-6 text-primary">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                                    @elseif($product->price)
                                                        <span
                                                            class="fw-6 text-primary">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                    @endif
                                                </h4>
                                            </div>
                                        </div>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="instagram-feed pt-50 px-30 position-relative">
                        <div class="bg-vector vector-8 position-absolute left-10">
                            <img src="{{ asset('assets/img/vcard23/vector9.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.feature.insta_embed') }}</h2>
                            <span></span>
                        </div>
                        <nav>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 position-relative">
                        <div class="bg-vector vector-9 position-absolute right-10">
                            <img src="{{ asset('assets/img/vcard23/vector5.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.feature.blog') }}</h2>
                            <span></span>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative">
                        <div class="bg-vector vector-10 position-absolute left-10">
                            <img src="{{ asset('assets/img/vcard23/vector18.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.business.business_hours') }}</h2>
                            <span></span>
                        </div>
                        <div class="business-hours row row-gap-20px justify-content-center py-3 mx-0" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            @foreach ($businessDaysTime as $key => $dayTime)
                            <div class="wrapper col-sm-6">
                                <div class="hours text-center">
                                    <div class="icon-calendar">
                                        <svg  xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-clock"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M10.5 21h-4.5a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v3"></path> <path d="M16 3v4"></path> <path d="M8 3v4"></path> <path d="M4 11h10"></path> <path d="M18 18m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path> <path d="M18 16.5v1.5l.5 .5"></path>
                                        </svg>
                                    </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                        <div class="bg-vector vector-11 position-absolute right-10">
                            <img src="{{ asset('assets/img/vcard23/vector4.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                    <div class="section-heading text-center">
                        <h2 class="text-black text-center mb-0">{{ __('messages.vcard.qr_code') }}</h2>
                        <span></span>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 position-relative">
                        <div class="bg-vector vector-12 position-absolute left-10">
                            <img src="{{ asset('assets/img/vcard23/vector12.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.vcard.iframe') }}</h2>
                            <span></span>
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-50 px-30 position-relative">
                        <div class="bg-vector vector-13 position-absolute right-10">
                            <img src="{{ asset('assets/img/vcard23/vector14.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                    <div class="section-heading text-center">
                        <h2 class="text-black text-center mb-0">{{ __('messages.contact_us.inquries') }}</h2>
                        <span></span>
                    </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30">
                        <div class="bg-vector vector-14 position-absolute left-10">
                            <img src="{{ asset('assets/img/vcard23/vector6.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.create_vcard') }}</h2>
                            <span></span>
                        </div>
                        <div class="">
            ...
            <div class="pt-50 px-30 position-relative">
                @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                    ...
                    <div class="map-section">
                        <div class="bg-vector vector-15 position-absolute right-10 top-4">
                            <img src="{{ asset('assets/img/vcard23/vector11.png') }}" alt="vector" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="map-location d-flex gap-2 align-items-center pb-3 pt-1" @if (getLanguage($vcard->
                            default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="map-section">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 rounded overflow-hidden d-flex justify-content-center" style="height: 300px;">
                ...
                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div>
                        <a class="text-decoration-none cursor-pointer terms-policies-btn"
                            href="{{ $vcardPrivacyAndTerm }}"><small class="text-primary">{!! __('messages.vcard.term_policy') !!}</small></a>
                    </div>
                @endif
            </div>
