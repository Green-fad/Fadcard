...
<body>
    ...
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden bg-white @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="profile-section position-relative bg-white pt-40 px-30">
                <div class="position-absolute top-0 start-0 w-100 h-100">
                    <img src="{{ asset('assets/img/vcard20/hero-main-bg.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                </div>
                <div class="card flex-sm-row align-items-center gap-2 gap-sm-4" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                   <div class="profile-bg-img">
                    <div class="card-img d-flex justify-content-center align-items-center">
                        <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                    </div>
                    </div>
                    <div class="card-body p-0 text-sm-start text-center @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @endif">
                        <div class="profile-name">
                            ...
                            <p class="fs-18 text-primary text-decoration-underline fw-5 mb-0">{{ ucwords($vcard->company) }}</p>
                ...
                {{-- social icon --}}
                    ...
                    <div class="social-media pt-40 d-flex flex-wrap justify-content-center gap-3 px-30 position-relative">
                        <div class="position-absolute vector-1 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-1.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                ...
                {{-- contact --}}
                    @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                        ...
                        !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                            ...
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-2.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-40 position-relative">
                        <div class="position-absolute vector-3 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-3.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                                        ...
                                        <div class="col-sm-6 d-flex flex-column">
                                            <div class="service-card card h-100">
                                                ...
                                                <div class="card-body p-0 text-center">
                                                    <h3 class="card-title text-white mb-2">{{ ucwords($service->name) }}
                                                    </h3>
                                                    <p
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-40 px-20 position-relative">
                        <div class="position-absolute vector-4 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-4.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center mb-40 overflow-hidden">
                            <h2 class="text-white mb-1 d-inline-block">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-40 px-20 position-relative">
                        <div class="position-absolute vector-5 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-5.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center overflow-hidden mb-40">
                            <h2 class="text-white mb-1 d-inline-block">
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-40 pb-40 position-relative">
                        <div class="position-absolute vector-6 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-6.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                                    ...
                                    <div class="testimonial-card">
                                        ...
                                        <div class="card-body position-relative px-0  text-center text-white">
                                             <div class="left-quote position-absolute top-0">
                                                <img src="{{ asset('assets/img/vcard20/right-quote.png') }}" alt="images" />
                                            </div>
                                            ...
                                            <div class="right-quote position-absolute bottom-0">
                                                <img src="{{ asset('assets/img/vcard20/left-quote.png') }}" alt="images" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-40 pb-40 px-30 position-relative">
                        <div class="position-absolute vector-7 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-7.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                                ...
                                <div>
                                    <div class="position-relative date-input">
                                        ...
                                        <span class="calendar-icon">
                                            <img src="{{ asset('assets/img/vcard20/calendar.svg') }}"
                                                loading="lazy" />
                                        </span>
                                        </span>
                                    </div>
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-feed-main pt-40 pb-40 position-relative">
                        <div class="position-absolute vector-8 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-8.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="px-30">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-40 pb-40 px-20 position-relative">
                        <div class="position-absolute vector-9 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-9.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                            ...
                            @foreach ($vcard->blogs as $blog)
                                ...
                                <div class="">
                                    <div class="blog-card  card">
                                        ...
                                        <div class="card-body w-100" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                            <a href="{{ $vcardBlogUrl }}">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-40 px-30 pb-40 position-relative">
                        <div class="position-absolute vector-10 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-10.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center mb-40 overflow-hidden">
                            <h2 class="text-white mb-1 d-inline-block">
                ...
                <div class="business-hour-card row row-gap-30px justify-content-center position-relative">
                    ...
                    <div class="col-sm-6">
                        <div class="business-hour align-items-center">
                            ...
                            <div class="text-center">
                                <span class="text-white">{{ __('messages.business.' .
                                    \App\Models\BusinessHour::DAY_OF_WEEK[$key])
                                    }}:</span>
                                <span class="text-primary">{{ $dayTime ?? __('messages.common.closed') }}</span>
                            </div>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="col-sm-6 mb-3 pe-sm-2">
                        <div class="business-hour align-items-center">
                            ...
                            <div class="business-details text-center">
                                <span class="text-white">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key])
                                    }}:</span>
                                <span class="text-primary">{{ $dayTime ?? __('messages.common.closed') }}</span>
                            </div>
                        </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-40 px-30 pb-40 position-relative">
                    <div class="position-absolute vector-11 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-11.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                    <div class="section-heading text-center mb-40 overflow-hidden">
                        <h2 class="text-white mb-1 d-inline-block">
                    ...
                    <div class="d-flex flex-sm-row flex-column gap-3 position-relative z-1 align-items-center" @if (getLanguage($vcard->
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-40 pb-40 position-relative px-30">
                        <div class="position-absolute vector-12 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-12.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center mb-40 overflow-hidden">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-40 pb-40 px-30 position-relative">
                    <div class="position-absolute vector-13 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-13.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                    <div class="section-heading text-center overflow-hidden mb-40">
                        <h2 class="text-white mb-1 d-inline-block">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-40 pb-40 px-30 position-relative">
                    <div class="position-absolute vector-14 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-14.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                    ...
                    <div class="vcard-link-card card">
                        <div class="d-flex justify-content-center align-items-center gap-2 gap-sm-3" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                    ...
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-15 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-15.png') }}" loading="lazy" class="w-100 h-100 object-fit-cover" />
                        </div>
                ...
                @if ($vcard->location_type == 1 && !empty($vcard->location_embed_tag))
                    <div class="pt-50 px-30 position-relative">
                        ...
                        <div class="map-section">
                            ...
                            <div class="embed-responsive embed-responsive-16by9 rounded overflow-hidden justify-content-center d-flex mt-4" style="height: 300px;">
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn food-services-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
