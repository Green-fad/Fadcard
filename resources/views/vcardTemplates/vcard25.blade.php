        ...
        @endif
            <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                ...
                <div class="banner-section position-relative">
                    ...
                    <div class="position-absolute  end-0 start-0 banner-bottom-img">
                        <img src="{{ asset('assets/img/vcard25/banner-bottom-img.png') }}" alt="profile-bg" loading="lazy" class="w-100" />
                    </div>
                ...
                {{-- profile detials --}}
                <div class="profile-section px-30 position-relative pt-40"
                    ...
                    <div class="card d-flex flex-sm-row  align-items-center position-relative gap-4  overflow-hidden bg-primary"
                        @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div class="dots-img">
                        ...
                        <div class="heart-img">
                            <img src="{{ asset('assets/img/vcard25/hert-shape.png') }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                        </div>
                        <div class="card-body text-sm-start text-center mt-sm-0 pt-sm-0 p-0">
                            <div class="profile-name text-white">
                                <h2 class="fs-28 text-white d-flex gap-3 align-items-center">
                                ...
                                <p class="fs-16 mb-1 text-secondary fw-medium text-decoration-underline">{{ ucwords($vcard->company) }}</p>
                                <p class="fs-14  mb-0">{{ ucwords($vcard->occupation) }}</p>
                                <p class="fs-14  mb-0">{{ ucwords($vcard->job_title) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-gray-100 profile-desc mb-sm-0 fs-14 text-center pt-50 position-relative">
                        {!! $vcard->description !!}
                    ...
                    <div class="social-media d-flex justify-content-center flex-wrap mb-40 position-relative">
                        <div class="bg-vector vector-2 position-absolute">
                            <img src="{{ asset('assets/img/vcard25/vector13.png') }}" alt="profile-bg">
                        </div>
                            <div
                                class="social-icons position-relative d-flex justify-content-center text-decoration-none flex-wrap text-primary bg-gray-100 rounded-pill pt-50">
                                @foreach (getSocialLink($vcard) as $value)
                                    <span
                                        ...
                                        {!! $value !!}
                                        <div class="social-bg">
                                            <img src="{{ asset('assets/img/vcard25/social-bg2.svg') }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                                        </div>
                                    </span>
                                @endforeach
                            </div>
            ...
            @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                    <div class="contact-section">
                        <div class="bg-vector vector-3 position-absolute right-10">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6">
                                        <div class="contact-box text-center">
                                            ...
                                            <div class="contact-desc">
                                                <p class="text-white fs-6 fw-5 mb-0">{{ $vcard->dob }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box text-center">
                                            ...
                                            <div class="contact-desc">
                                                <p class="text-white fs-6 fw-5 mb-0">{!! ucwords($vcard->location) !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                ...
                @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                    @if (checkFeature('gallery') && $vcard->gallery->count())
                        <div class="gallery-section pt-50 px-30 position-relative mb-0 position-relative">
                            ...
                            <div class="line-img position-absolute">
                                <img src="{{ asset('assets/img/vcard25/line.png') }}" alt="gallery-bg" class="w-100 h-100" />
                            </div>
                            <div class="heart-img">
                ...
                @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                    @if (checkFeature('services') && $vcard->services->count())
                        <div class="our-services-section pt-50">
                            <div class="bg-vector vector-4 top-10 position-absolute left-10">
                                        ...
                                        @foreach ($vcard->services as $service)
                                            <div>
                                                <div class="service-card h-100">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="dots-img">
                                                            <img src="{{ asset('assets/img/vcard25/dots-green.svg') }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                                                        </div>
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                ...
                @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                    @if (checkFeature('products') && $vcard->products->count())
                        <div class="product-section pt-50 px-20">
                            <div class="bg-vector vector-5 position-absolute">
                            ...
                            <div class="section-heading text-center">
                                            ...
                                            <div class="product-card card overflow-hidden">
                                                ...
                                                <div class="product-desc align-items-center position-relative">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column gap-2 align-items-center">
                                                        ...
                                                        <h4 class="text-center text-black mb-0 fs-20">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="fs-18 fw-6">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="fs-18 fw-6">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                            @endif
                                                        </h4>
                                                    </div>
                                                </div>
                                ...
                                <div class="text-center">
                                        <div class="mt-4 text-center view-more d-inline-flex gap-2 align-items-center btn-primary position-relative">
                                ...
                                <div class="">
                                    <div class="px-3 position-relative">
                                        ...
                                        <div class="appointment-btn text-center w-100 position-relative">
                                            ...
                                            <button class="appointmentAdd btn btn-primary w-100 d-none text-white">
                                ...
                                @foreach ($vcard->testimonials as $testimonial)
                                    <div class="">
                                        <div class="testimonial-card card d-flex flex-sm-row align-items-center text-center text-sm-start gap-4"
                                            ...
                                            <div class="card-body">
                                                <div class="quote-img">
                                                    <img src="{{ asset('assets/img/vcard25/quote-img-25.png') }}"
                                                        alt="quote-img" class="w-100 h-100" loading="lazy" />
                                                </div>
                                                <h3 class=" fs-20 fw-6 mb-2 text-primary d-flex align-items-center gap-2">
                                            ...
                                            <div class="dots-img">
                                                <img src="{{ asset('assets/img/vcard25/testimonial-vector.svg') }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                ...
                @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                    @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                        <div class="position-relative insta-feed pt-50 px-30 start-0">
                            <div class="bg-vector vector-8 position-absolute">
                ...
                @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                    @if (checkFeature('blog') && $vcard->blogs->count())
                        <div class="blog-section pt-50 px-20">
                            <div class="bg-vector vector-9 position-absolute right-10 top-10">
                ...
                @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                    <div class="qr-code-section pt-50 px-30">
                            <div class="bg-vector vector-10 position-absolute left-10 top-10">
                ...
                @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                    @if ($vcard->businessHours->count())
                        ...
                        <div class="business-hour-section pt-50 px-30 position-relative">
                            <div class="bg-vector vector-11 position-absolute right-10 top-0">
                                <img src="{{ asset('assets/img/vcard25/vector9.png') }}" alt="profile-bg">
                            </div>
                            <div class="position-absolute start-0 top-0 business-bg w-40">
                                <img src="{{ asset('assets/img/vcard25/business-bg.png') }}" alt="vector" class="w-100 h-100" />
                            </div>
                            <div class="section-heading text-center">
                            ...
                            <div class="justify-content-center row business-time mx-0 row-gap-20">
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                    <div class="time-body text-center">
                                        <div class="days">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}:</div>
                                            <div class="time">
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    @if (getLanguage($vcard->default_language) != 'Arabic')
                        <div class="contact-us-section pt-30 px-30 position-relative">
                            <div class="bg-vector vector-11 position-absolute left-10 top-0">
                            ...
                            <div class="dot-img">
                                    <img src=" {{ asset('assets/img/vcard25/testimonial-vector.svg') }}" alt="imgaes" class="w-100"/>
                                </div>
                                <div class="shape-top-2">
                                    <img src="{{ asset('assets/img/vcard25/shape-4.png') }}" class="w-100 h-100" loading="lazy" />
                                </div>
                ...
                <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                    <div class="fixed-btn-section">
                        @if (empty($vcard->hide_stickybar))
                            <div
                                class="bars-btn social-services-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
