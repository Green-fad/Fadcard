    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                    ...
                    <div class="pwa-support d-flex align-items-center justify-content-center">
                        <div>
                            ...
                            <div class="text-end d-flex">
                                <button id="installPwaBtn" class="pwa-install-button w-50 mb-1 btn-primary btn">{{__('messages.pwa.install')}} </button>
                    ...
                    <div class="card d-flex flex-sm-row  align-items-center position-relative gap-sm-5 gap-2 overflow-hidden">
                        ...
                        <div class="card-body position-relative z-1">
                            <div class="profile-name">
                                ...
                                <p class="fs-16 text-primary text-decoration-underline mb-0 fw-5">{{ ucwords($vcard->company) }}</p>
                        ...
                        <div class="position-absolute bottom-0 end-0 bags-img">
                             <img src="{{ asset('assets/img/vcard19/profile-bg.png') }}" alt="flower-bg" class="w-100 h-100" loading="lazy" />
                         </div>
                    </div>
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic')
                <div class="card d-flex flex-sm-row  align-items-center position-relative gap-sm-5 gap-2 overflow-hidden" dir="rtl">
            ...
            !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                    <div class="contact-section pt-50 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                                ...
                                                <div class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard19/email.svg') }}" alt="" loading="lazy">
                                                </div>

                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->email }}" class="text-black fs-14 fw-5">{{
                                                    $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if ($vcard->alternative_email)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->alternative_email }}" class="text-black fs-14 fw-5">{{
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard19/phone-icon.svg') }}" alt="">
                                            </div>

                                            <div class="contact-desc">
                                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-black fs-14 fw-5" dir="ltr">+{{ $vcard->region_code }}{{
                                                    $vcard->phone }}</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                    class="text-black fs-14 fw-5" dir="ltr">+{{ $vcard->alternative_region_code
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <a href="" class="text-black mb-0 fs-14 fw-5">{!! ucwords($vcard->location) !!}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
            ...
            @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                <div class="custom-link-section position-relative">
                    <div class="custom-link d-flex flex-wrap justify-content-center pt-40 w-100 position-relative gap-2">
                        <div class="flower-bg position-absolute end-0 top-0 -z-1">
                            <img src="{{ asset('assets/img/vcard19/bg-flower.png') }}" alt="images" class="w-100">
                        </div>
                        ...
                        <div class="gallery-slider px-20">
                            @foreach ($vcard->gallery as $file)
                                ...
                                <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images">
                                    <img src="{{ $file->gallery_image }}" alt="profile" class="w-100 h-100 d-block" loading="lazy" />
                                </a>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 position-relative">
                      <div class="bg-vector position-absolute right-10 top-40 text-end">
                            <img src="{{ asset('assets/img/vcard19/vector18.png') }}" alt="images" class="w-100">
                        </div>
                      <div class="flower-left">
                            <img src="{{ asset('assets/img/vcard19/flower-left.png') }}" alt="flower-bg" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                        ...
                        <div class="px-20">
                                            ...
                                            <div class="product-desc card-body text-center">
                                                ...
                                                <div class="text-center fs-20 fw-5">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="product-amount">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                            ...
                            <div class="text-center mt-4 view-more btn-primary max-w-fit mx-auto">
                                <a class="fs-6 text-decoration-none mb-0 d-flex align-items-center gap-2" href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}
                    ...
                    <div class="our-services-section pt-50 position-relative">
                        <div class="bg-vector position-absolute left-10 top-40">
                         ...
                         <div class="bg-vector position-absolute right-10 top-0 text-end">
                            <img src="{{ asset('assets/img/vcard19/vector23.png') }}" alt="images" class="w-100">
                        </div>
                        <div class="section-heading text-center">
                                        ...
                                        <div>
                                            <div class="service-card h-100 card">
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    ...
                                                    <img src="{{ $service->service_icon }}" class="card-img-top service-new-image h-100 w-100 object-fit-cover"
                                                        alt="{{ $service->name }}" loading="lazy">
                                                </a>
                                                <div class="card-body text-center position-relative">

                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none" target="{{ $service->service_url ? '_blank' : '' }}">
                                                        <h5 class="card-title title-text"> {{ ucwords($service->name) }} </h5>
                                                    </a>
                                                    <p class="card-text description-text mb-0 text-black px-3 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                    ...
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6">
                                           <div class="service-card h-100 card">
                                                ...
                                                <div class="card-body text-center position-relative">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none" target="{{ $service->service_url ? '_blank' : '' }}">
                                                        <h5 class="card-title title-text text-primary"> {{ ucwords($service->name) }} </h5>
                                                    </a>
                                                    <p class="card-text description-text mb-0 text-black px-3 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                        {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                                                    </p>
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30 position-relative">
                        ...
                        <div class="flower-right">
                            <img src="{{ asset('assets/img/vcard19/flower-right.png') }}" alt="appointment" class="w-100 h-100 object-fit-cover">
                        </div>
                        <div class="section-heading text-center">
                        ...
                        <div class="position-relative">
                            <div class="appointment">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="appointmentAdd btn btn-primary w-100 d-none max-w-fit">
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 position-relative">
                     <div class="bg-vector position-absolute end-0 top-40 vector3">
                            <img src="{{ asset('assets/img/vcard19/vector11.png') }}" alt="images" class="w-100">
                    </div>
                    <div class="testimonial-vector">
                        <img src="{{ asset('assets/img/vcard19/left-vector.png') }}" alt="testimonial-vector" class="w-100">
                    </div>
                        <div class="section-heading text-center">
                            ...
                            @foreach ($vcard->testimonials as $testimonial)
                                <div class="testimonial-card card flex-row align-items-center gap-5 d-flex">
                                    <div class="main-testimonial-img">
                                        ...
                                        <div
                                            class="quote-right-img quote-img">
                                            <i class="fa-solid fa-quote-right text-white fs-3"></i>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="text-center testi-desc mt-4 p-2">
                                            <h3 class="text-primary fs-20 mb-3">{{ ucwords($testimonial->name) }} </h3>
                                            <p class="desc text-black mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn fashion-bars-btn  @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="map-section px-30 pt-50">
                        <div class="map-search">
                            <div class="map-location d-flex gap-2 align-items-center pb-2" @if (getLanguage($vcard-> default_language) == 'Arabic') dir="rtl" @endif>
                ...
                @if ($vcard->location_type == 1 && !empty($vcard->location_embed_tag))
                     <div class="map-section px-30 pt-50">
                        <div class="map-search">
                            <div class="map-location d-flex gap-2 align-items-center mb-3" @if (getLanguage($vcard-> default_language) == 'Arabic') dir="rtl" @endif>
                              <div class="location-icon position-relative">
                                    <div class="location-img d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard19/location-icon.svg') }}">
                                    </div>
            ...
            @endif
                ...
                <img src="{{ asset('assets/img/vcard19/bottom-bg.png') }}" alt="images" class="w-100 h-100 object-fit-cover" />
                </div>
                {{-- made by --}}
                        ...
                        @if (checkFeature('advanced')->hide_branding && $vcard->branding == 0)
                            @if ($vcard->made_by)
                                <a @if (!is_null($vcard->made_by_url)) href="{{ $vcard->made_by_url }}" @endif
                                    ...
                                    <small class="text-primary fs-14">{{ __('messages.made_by') }} {{ $vcard->made_by }}</small>
                                </a>
                            @else
                                <div class="text-center">
                    ...
                    @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                        <div>
                            <a class="text-decoration-none text-dark cursor-pointer terms-policies-btn fs-14"
                                href="{{ $vcardPrivacyAndTerm }}"><small class="text-primary fs-14">{!! __('messages.vcard.term_policy') !!}</small></a>
                        </div>
                    @endif
                </div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" method="post" id="newsLatterForm">
                            ...
                            <div class="mb-1 mt-1 d-flex gap-1 justify-content-center align-items-center email-input">
                                <div class="w-100">
                                <input type="email" class="text-light form-control  bg-dark border-dark email-input w-100"
