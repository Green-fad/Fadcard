...
<body>
    ...
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden position-relative @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="profile-section position-relative">
                <div class="profile-bg h-100"> <img src="{{ asset('assets/img/vcard33/profile-bg1.png') }}" class="w-100 h-100 object-fit-cover" alt="images" /></div>
                <div class="card d-flex flex-sm-row gap-3 pt-4 pt-sm-0 gap-sm-5 align-items-center">
                    <div class="card-img-main position-relative">
                        <div class="line-1"> <img src="{{ asset('assets/img/vcard33/line-1.png') }}" class="w-100" alt="images" /></div>
                        <div class="line-2"> <img src="{{ asset('assets/img/vcard33/line-2.png') }}" class="w-100" alt="images" /></div>
                ...
                <div class="social-media-section pt-40 position-relative px-30" @if (getLanguage($vcard->default_language) ==
                    'Arabic') dir="rtl" @endif>
                    <div class="position-absolute vector-all vector-1">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-1.png') }}" class="w-100" alt="images" />
                        </div>
                    <div class="social-media d-flex flex-wrap justify-content-center">
                        @foreach (getSocialLink($vcard) as $value)
                        <span class="social-icon d-flex justify-content-center align-items-center position-relative">
                            {!! $value !!}
                            <div class="play-svg">
                                <svg width="50" height="50" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0.92304 25.0022L0.92304 9.85C0.923041 1.17377 7.50917 -2.45174 15.5559 1.74886L30.4809 9.54996L44.5029 16.901C53.0277 21.3516 53.0277 28.6527 44.5029 33.1033L30.4544 40.4543L15.5294 48.2554C7.48261 52.456 0.896484 48.8055 0.896485 40.1543L0.896485 25.0022L0.92304 25.0022Z" fill="url(#paint0_linear_527_3)"></path>
                                    <defs>
                                    <linearGradient id="paint0_linear_527_3" x1="50.8965" y1="25" x2="0.896483" y2="25" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#C42091"></stop>
                                    <stop offset="1" stop-color="#6617CA"></stop>
                                    </linearGradient>
                                    </defs>
                                </svg>
                            </div>
            ...
            <div class="pt-50 px-30 position-relative">
                <div class="position-absolute vector-all vector-2 text-end">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-2.png') }}" class="w-100" alt="images" />
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="contact-box d-flex align-items-center">
                                ...
                                <div class="contact-desc">
                                    <a href="mailto:{{ $vcard->alternative_email }}" class="text-white fs-14 fw-5">{{ $vcard->alternative_email
                                        }}</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="contact-box d-flex align-items-center">
                                ...
                                <div class="contact-desc">
                                    <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                        class="text-white fs-14 fw-5">+{{ $vcard->alternative_region_code }}{{
                    ...
                    <div class="row" dir="rtl">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="contact-box d-flex align-items-center">
                                ...
                                <div class="contact-desc">
                                    <a href="mailto:{{ $vcard->email }}" class="text-white fs-14 fw-5">{{ $vcard->email
                                        }}</a>
                                </div>
                            </div>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                ...
                <div class="gallery-section pt-50 position-relative">
                    <div class="position-absolute vector-all vector-3">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-3.png') }}" class="w-100" alt="images" />
                            </div>
            ...
            <div class="our-services-section pt-50 position-relative">
                <div class="position-absolute vector-all vector-4 text-end">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-4.png') }}" class="w-100" alt="images" />
                        </div>
                <div class="section-heading text-center">
            ...
            <div class="pt-50 position-relative">
                <div class="position-absolute vector-all vector-5">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-5.png') }}" class="w-100" alt="images" />
                        </div>
                <div class="appointment-section pt-60 pb-60 px-30" @if (getLanguage($vcard->default_language) ==
                    'Arabic')
                    dir="rtl" @endif>
            ...
            <div class="product-section pt-50 px-20 position-relative">
                    <div class="position-absolute vector-all vector-6 text-end">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-6.png') }}" class="w-100" alt="images" />
                    </div>
                <div class="section-heading text-center">
                                    ...
                                    <div class="product-desc card-body w-100 position-relative overflow-hidden">
                                        <div class="d-flex justify-content-between align-items-center mb-1 flex-column gap-2 overflow-hidden">
                                            <h3 class="text-center fw-5 mb-0 product-title">{{
                                                $product->name }}</h3>
                                            <p
                                                class="amount product-amount mb-0">
                                                @if ($product->currency_id && $product->price)
                                                <span class="fw-6 text-white">{{ $product->currency->currency_icon
            ...
            <div class="pt-50 px-20 position-relative">
                <div class="position-absolute vector-all vector-7">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-7.png') }}" class="w-100" alt="images" />
                        </div>
                    ...
                    <div class="testimonial-slider">
                        ...
                        <div>
                            <div class="testimonial-card card">
                                <div class="bg-img">
                                    <img src="{{ asset('assets/img/vcard33/testimonial-bg1.png') }}" />
                                </div>
                                <div class="testimonial-content">
                                    ...
                                    <div class="card-body p-0 text-center">
                                        <h3 class="text-white text-decoration-underline mb-10">{{
            ...
            <div class="pt-50 position-relative">
                <div class="position-absolute vector-all vector-8 text-end">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-8.png') }}" class="w-100" alt="images" />
                        </div>
                <div>
            ...
            <div class="blog-section pt-50 px-20 position-relative">
                <div class="position-absolute vector-all vector-9">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-9.png') }}" class="w-100" alt="images" />
                        </div>
                <div class="section-heading mb-5 text-center">
                ...
                <div class="blog-slider">
                    ...
                    <div>
                        <div class="card-wrapper">
                            <div class="blog-card card" @if (getLanguage($vcard->default_language) == 'Arabic')
                                dir="rtl"
                                @endif>
                                <div class="card-img">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-1 d-flex align-items-center justify-content-end">
                                        <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"
                                            ...
                                            {{ __('messages.vcard_11.read_more') }} <i class="fa-solid fa-arrow-right-long"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="pt-50 position-relative">
                <div class="position-absolute vector-all vector-10 text-end">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-10.png') }}" class="w-100" alt="images" />
                        </div>
                <div class="business-hour-section pt-60 pb-60 px-30 position-relative">
                    <div class="section-heading text-white mb-5 text-center">
            ...
            <div class="qr-code-section pt-50 px-30 position-relative">
                <div class="position-absolute vector-all vector-11">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-11.png') }}" class="w-100" alt="images" />
                        </div>
                <div class="section-heading mb-5 text-center">
                    ...
                    <div class="qr-code mx-auto position-relative">
                        <div class="qr-content">
                            <div class="d-flex gap-3 align-items-center flex-wrap flex-sm-nowrap justify-content-center text-center text-sm-start"
                                ...
                                <div>
                                    <h5 class="text-white fs-20 fw-6">{{ __('messages.vcard.scan_to_contact') }}</h5>
            ...
            <div class="iframe-section pt-50 px-20 position-relative">
                <div class="position-absolute vector-all vector-12 text-end">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-12.png') }}" class="w-100" alt="images" />
                        </div>
                <div class="section-heading mb-5 text-center">
            ...
            <div class="pt-50 position-relative">
                <div class="position-absolute vector-all vector-13">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-13.png') }}" class="w-100" alt="images" />
                        </div>
                <div class="contact-us-section pt-60 pb-60 px-30 position-relative">
                    <div class="section-heading mb-5 text-center">
                        <h2 class="mb-0 fw-6 text-white">{{ __('messages.contact_us.inquries') }}</h2>
                    </div>
                    @if (getLanguage($vcard->default_language) != 'Arabic')
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-4 mt-2 d-flex gap-2">
                                    ...
                                    <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                        <span class="text-gray-100 fs-14">{{ __('messages.vcard.agree_to_our') }}</span>
                                        <a href="{{ route('vcard.show-privacy-policy', [$vcard->url_alias, $vcard->id]) }}"
                                            target="_blank"
                                            class="text-decoration-underline link-info text-white fs-14">{!!
                                            __('messages.vcard.term_and_condition') !!}</a>
                                        <span class="text-gray-100 fs-14">&</span>
                                        <a href="{{ route('vcard.show-privacy-policy', [$vcard->url_alias, $vcard->id]) }}"
                                            target="_blank"
                                            class="text-decoration-underline link-info text-white fs-14">{{
            ...
            <div class="create-vcard-section pt-50 px-30 position-relative">
                <div class="position-absolute vector-all vector-14 text-end">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-14.png') }}" class="w-100" alt="images" />
                        </div>
                <div class="content">
                    <div class="section-heading mb-5 text-center">
                    ...
                    <div class="card-wrapper">
                        <div class="card-content">
                            <div class="vcard-link-card card">
                                <div class="d-flex gap-3 align-items-center justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic')
                                dir="rtl"
                                @endif>
                                    <a href="{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}"
                                        class="text-white fs-14 fw-medium d-block">{{ route('register', ['referral-code'
            ...
            <div class="pt-50 px-30 position-relative">
                <div class="position-absolute vector-all vector-15">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-15.png') }}" class="w-100" alt="images" />
                        </div>
                    <div class="map-section">
                        <div class="map-content">
                            <div class="map-location d-flex gap-2 align-items-center py-2" @if (getLanguage($vcard->
            ...
            <div class="add-to-contact-section">
                <div class="text-center d-flex align-items-center justify-content-center" @if (getLanguage($vcard->
                    ...
                    @else
                    <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn rounded-4 btn btn-gradient">
                        <div class="wave"></div>
...
<script src="https://cdn.jsdelivr.net/npm/tsparticles@2/tsparticles.bundle.min.js"></script>
  <script>
    tsParticles.load("vcardthirty-effect-bg", {
      background: {
        color: "transparent" // transparent to let CSS gradient show
      },
      fpsLimit: 60,
      particles: {
        number: { value: 40 },
