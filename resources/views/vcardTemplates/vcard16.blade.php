...
<body>
    <div class="vcard-sixteen-effect"></div>
        ...
        <div
            ...
            <div class="support-banner d-flex align-items-center justify-content-center">
                ...
                <div class="">
                    ...
                    <div class="text-center">
                        <a href="{{ $banners->url }}" class="act-now text-light" target="_blank" data-turbo="false">{{
            ...
            <div class="profile-section px-30 pt-30 pb-50 position-relative">
                ...
                <div class="row justify-content-end">
                    ...
                    <img src="{{ asset('assets/img/vcard16/profile-bg-vector.png') }}" alt="profile-bg" />
                            ...
                            <div class="card-body text-center p-0">
                                <div class="profile-name">
                                    ...
                                    <p class="fs-18 text-decoration-underline fw-5 mb-0">{{ ucwords($vcard->company) }}</p>
                            ...
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="tel:+ {{ $vcard->region_code }}
                                            {{ $vcard->phone }}" class="text-primary mb-0 fs-14" dir="ltr">+{{
                                        $vcard->region_code }}
                                        {{ $vcard->phone }}</a>
                                </div>
                            </div>
                            ...
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                        class="text-primary mb-0 fs-14" dir="ltr">+{{
            ...
            <div class="appointment-section pt-50 mt-50 pb-3 bg-primary position-relative">
               <div class="position-absolute vector-3 vector-all">
                    <img src="{{ asset('assets/img/vcard16/vector-1.png') }}" alt="images" class="w-100" />
                </div>
                <div class="section-heading text-center mb-40">
                    ...
                    <div class="row">
                        <div class="col-12 mb-20">
                            <div class="position-relative">
                                {{ Form::text('date', null, ['class' => ' date form-control appointment-input
                        ...
                        <div class="col-12 text-center mt-2">
                            <button class="btn btn-white appoint-btn appointmentAdd d-none">{{
            ...
            <div class="our-services-section pt-50">
                ...
                <div class="services-bg">
                    <img src="{{ asset('assets/img/vcard16/vector-13.png') }}" alt="" class="w-100" loading="lazy">
                </div>
                <div class="services">
                                    ...
                                    <div class="service-card card h-100 align-items-center">
                                        <div class="card-img d-flex justify-content-center align-items-center">
                                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                ...
                                                target="{{ $service->service_url ? '_blank' : '' }}">
                                                <img src="{{ $service->service_icon }}" alt="" class="object-fit-cover w-100"
                                                    loading="lazy" />
                                            </a>
                                        </div>
                                        <div class="card-body text-center">
            ...
            <div class="gallery-section px-20 position-relative pt-50">
                <div class="gallery-bg position-absolute vector-all">
                    <img src="{{ asset('assets/img/vcard16/gallery-bg.png') }}" class="w-100" loading="lazy">
                </div>
                <div>
                    <div class="section-heading text-center mb-40">
                            ...
                            <div class="wrapper">
                                ...
                                <div class="gallery-img img-2 mx-auto">
                                    <a id="file_url" href="{{ $file->gallery_image }}"
                                        ...
                                        <div class="gallery-item" @if ($extension=='pdf' )
            ...
            <div class="product-section pt-50 px-20 position-relative">
                <div class="position-absolute vector-5 vector-all text-end">
                    <img src="{{ asset('assets/img/vcard16/vector-8.png') }}" alt="images" class="w-100" />
                </div>
                <div class="section-heading text-center mb-40">
                        ...
                        <div class="">
                            <div class="product-card card">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div
                                        class="product-desc card-body d-flex align-items-center justify-content-center flex-column gap-2">
                                        <div class="product-title">
                                            <h3 class="text-gray-300 text-center fw-normal mb-0">{{ $product->name }}</h3>
                                        </div>
                                        <div class="product-amount text-primary  fs-18">
                                            @if ($product->currency_id && $product->price)
                                            <span class="text-dark">{{ $product->currency->currency_icon }}{{
                                                getSuperAdminSettingValue('hide_decimal_values') == 1 ?
                                                number_format($product->price, 0) : number_format($product->price, 2)
                                                }}</span>
                                            @elseif($product->price)
                                            <span class="text-dark">{{ getUserCurrencyIcon($vcard->user->id) . ' ' .
                                                $product->price }}</span>
                                            @endif
                                        </div>
                                    </div>
                ...
                <div class="text-center">
                    <div class="text-center view-more d-inline-flex gap-2 align-items-center">
                        <a class="fs-6" href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}</a>
            ...
            <div class="testimonial-section pt-50 px-20 position-relative">
                            ...
                            <div class="card-body p-0  text-center">
                                ...
                                <div class="position-relative">
                                    <div class="position-absolute quote-left">
                                        <img src="{{ asset('assets/img/vcard16/quote-left.svg') }}" alt="quote-left" />
                                    </div>
                                    <p
                ...
                <div class="testimonial-bg-img">
                    <img src="{{ asset('assets/img/vcard16/testimonial-bg-img.png') }}" loading="lazy" class="w-100" />
                </div>
            </div>
            @endif
            @endif
            ...
            <div class="insta-section pt-50 position-relative">
                <div class="position-absolute vector-6 vector-all text-end">
                    <img src="{{ asset('assets/img/vcard16/vector-6.png') }}" alt="images" class="w-100" />
                </div>
                <div class="section-heading text-center mb-40">
                ...
                <div class="blog-section pb-1 pt-50">
                    ...
                    <div class="px-20">
                        <div class="blog-slider">
                            ...
                            <?php
                                            ...
                                            ?>
                            <div class="">
                                <div class="blog-card card  align-items-center " @if (getLanguage($vcard->
                                    default_language) == 'Arabic') dir="rtl" @endif>
                                    <div class="card-img overflow-hidden">
                                        <a href="{{ $vcardBlogUrl  }}">
                                            <img src="{{ $blog->blog_icon }}" alt="profile" class="w-100 h-100 blog-img"
                                                loading="lazy" />
                                        </a>
                                    </div>
                    ...
                    <div class="blog-bg vector-all">
                        <img src="{{ asset('assets/img/vcard16/vector-14.png') }}" loading="lazy" class="w-100">
                    </div>
                </div>
                @endif
                @endif
                ...
                <div class="business-hour-section pt-50 mt-50 pb-30 bg-primary position-relative">
                    <div class="position-absolute vector-7 vector-all">
                        <img src="{{ asset('assets/img/vcard16/vector-7.png') }}" alt="images" class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-white text-center mb-2">{{ __('messages.business.business_hours') }}</h2>
                    </div>
                    <div class="px-30">
                        <div class="bussiness-hour-card row justify-content-center row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            ...
                            <div class="col-sm-6">
                                <div class="days d-flex gap-2 align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="fw-5"> {{ $dayTime ?? __('messages.common.closed') }}</div>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="qr-code-section pt-50 position-relative">
                    ...
                    <div class="px-30">
                        <div class="align-items-center flex-sm-row flex-column-reverse justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                <div
                ...
                <div class="iframe-section pt-50 px-20 position-relative">
                    <div class="position-absolute vector-8 vector-all text-end">
                        <img src="{{ asset('assets/img/vcard16/vector-11.png') }}" alt="images" class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-1">
                                        ...
                                        <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                            <span class="text-gray-300">{{ __('messages.vcard.agree_to_our') }}</span>
                                            <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                class="fw-5 link-info">{!! __('messages.vcard.term_and_condition')
                                                !!}</a>
                    ...
                    <div class="vcard-link-card card">
                        <div class="d-flex justify-content-center align-items-center gap-2 gap-sm-3" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <a target="_blank"
                                ...
                                class="fw-5 text-white link-text">{{ route('register', ['referral-code' =>
                ...
                <div class="pt-50 px-30 position-relative">
                    <div class="position-absolute vector-12 vector-all">
                        <img src="{{ asset('assets/img/vcard16/vector-4.png') }}" alt="images" class="w-100" />
                    </div>
                ...
                <div class="px-30 pt-50 position-relative">
                    ...
                    <div class="map-section">
                        ...
                        <div class="map-location d-flex gap-2 align-items-center pt-2" @if (getLanguage($vcard-> default_language) == 'Arabic') dir="rtl" @endif>
                            <div class="location-icon d-flex justify-content-center align-items-center">
                ...
                <div class="add-to-contact-section px-30 text-center">
                    <div class="d-inline-block" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                        <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}" class="vcard16-sticky-btn add-contact-btn gap-2 sticky-vcard16-div d-flex justify-content-center  align-items-center
                ...
                <div
                    ...
                    <div class="fixed-btn-section">
                        ...
                        <div
                            class="bars-btn lawyer-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
