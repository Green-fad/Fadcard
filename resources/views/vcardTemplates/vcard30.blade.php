...
<body>
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            {{-- profile section --}}
            <div class="profile-section pt-40 px-30"  @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                <div class="profile-bg-img">
                    <img src="{{ asset('assets/img/vcard30/profile-bg.png') }}" alt="bg" />
                    </div>
                            <div class="card d-flex flex-column gap-3 flex-sm-row align-items-sm-end align-items-center overflow-hidden">
                                ...
                                <div class="card-body text-sm-start text-center position-relative p-0 pb-3">
                                    <div class="profile-name text-center text-sm-start">
                                        ...
                                        <p class="fs-18 text-dark mb-1 text-decoration-underline">{{ ucwords($vcard->company) }}</p>
            ...
            !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                    <div class="contact-section pt-50 px-30 position-relative">
                        ...
                        <div class="row row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            @if ($vcard->email)
                                <div class="col-sm-6">
                                    <div
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6">
                                <div class="contact-box d-flex flex-sm-column flex-row align-items-center position-relative">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                ...
                                <div>
                                    <div class="gallery-img position-relative">
                                        ...
                                        @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                            <a href="{{ $file->gallery_image }}" class="text-dark" data-lightbox="gallery-images"><img
                                        ...
                                        <div class="product-card card"
                                            ...
                                            <div class="product-desc card-body">
                                                <div class="text-center d-flex flex-column gap-2">
                                                    <div>
                                                        <p class="fs-18 text-white mb-0 product-name">{{ $product->name }}</p>
                                                    </div>
                                                    <div>
                                                        <p class="amount mb-0 fw-5">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="fw-6">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="fw-6">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
                                ...
                                <div>
                                    <div class="testimonial-card card">
                                        <div class="quote-img left-img">
                                            <img src="{{asset('assets/img/vcard30/quote-left-img.png')}}" loading="lazy"/>
                                            </div>
                                            <div class="quote-img right-img">
                                            <img src="{{asset('assets/img/vcard30/quote-right-img.png')}}" loading="lazy"/>
                                            </div>
                                        <div class="card-body p-0 text-center">
                                            <p
                        ...
                        <div class="business-hour-card row justify-content-center position-relative row-gap-20px">
                            @foreach ($businessDaysTime as $key => $dayTime)
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-calendar-time text-dark" width="24" height="24"
                            ...
                            <div class="text-center d-flex flex-column justify-content-center align-items-center">
                                <span class="text-dark">{{ __('messages.business.' .
                                    \App\Models\BusinessHour::DAY_OF_WEEK[$key])
                                    }}:</span>
                                <span class="text-dark">{{ $dayTime ?? __('messages.common.closed') }}</span>
                            </div>
                                    </div>
                                </div>
                            @endforeach
                                    ...
                                    <div class="blog-card d-flex flex-column align-items-center"
                                        ...
                                        <div class="card-body text-start">
                                            ...
                                            <div class="d-flex align-items-center justify-content-end mt-2">
                                                <a href="{{ $vcardBlogUrl }}" class="read-more text-dark d-inline-flex align-items-center justify-content-end gap-2 fs-14" tabindex="0">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section px-30 pt-50 position-relative">
                    ...
                    <div class="qr-code d-flex justify-content-center align-items-center flex-wrap flex-sm-nowrap" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                            ...
                                            <div class="wrapper-file-input">
                                                <div class="input-box" id="fileInputTrigger">
                                                    <h4> <i
                                                        ...
                                                        hidden multiple />
                                                </div> <small class="text-primary fs-12">{{ __('messages.file_supported') }}</small>
                                            </div>
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                ...
                <div class="map-section px-30 pt-50 position-relative">
                    ...
                    <div class="map-content">
                        <div class="map-location py-2 px-3 d-flex gap-2 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                ...
                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div>
                        <a class="text-decoration-none text-dark cursor-pointer terms-policies-btn"
                            href="{{ $vcardPrivacyAndTerm }}"><small class="text-dark">{!! __('messages.vcard.term_policy') !!}</small></a>
                    </div>
                @endif
            </div>
            {{-- sticky buttons --}}
