...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-two main-content w-100 mx-auto overflow-hidden content-blur  allSection @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- banner --}}
            <div class="vcard-two__banner w-100 position-relative">
                ...
                @elseif($vcard->cover_type == 1)
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" loop
                ...
                <div class="youtube-link-2">
                    <iframe src="https://www.youtube.com/embed/{{ YoutubeID($vcard->youtube_link) }}?autoplay=1&mute=1&loop=1&playlist={{ YoutubeID($vcard->youtube_link) }}&controls=0&modestbranding=1&showinfo=0&rel=0"
            ...
            {{-- profile details --}}
            <div class="vcard-two__profile-details py-3 px-3 p-5 @if($vcard->cover_type == 2) profile-desc-margin @endif">
                <div class="max-w-350">
