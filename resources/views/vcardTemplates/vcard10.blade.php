...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-ten main-content w-100 mx-auto overflow-hidden content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- Pwa support --}}
                                        ...
                                        <div
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                ...
                                                <h5><a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="event-name text-sm-start text-center mb-0 text-decoration-none" dir="ltr">+{{ $vcard->region_code }}
                                                        {{ $vcard->phone }}</a>
                                                </h5>
                                            </div>
                                        </div>
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                ...
                                                <h5>
                                                    <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                                        class="event-name text-sm-start text-center mb-0 text-decoration-none" dir="ltr">+{{ $vcard->alternative_region_code }}
                                            ...
                                            <div
                                                ...
                                                <div class="product-details mt-3">
                                                    ...
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="text-whitek">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                        ...
                                        <div class="contact-form px-sm-5">
                                            ...
                                            <div class="mb-3">
                                                <input type="tel" name="phone" class="form-control"
                                                    id="phone" placeholder="{{ __('messages.form.phone') }}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)">
                                            </div>
                                            <div class="mb-3">
                        ...
                        <div class="modal-content animate-bottom" id="newsLatter-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="" method="post" id="newsLatterForm">
                                    ...
                                    <div class="mb-3 mt-5 d-flex gap-1 justify-content-center align-items-center email-input">
                                        <div class="w-100">
