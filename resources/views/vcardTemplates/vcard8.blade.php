...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-eight main-content w-100 mx-auto overflow-hidden content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="vcard-eight__banner w-100 position-relative">
                ...
                @elseif($vcard->cover_type == 1)
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video height="400px"
                            class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" loop
                            autoplay muted playsinline alt="background video" id="cover-video">
                ...
                <div class="youtube-link-8">
                    <iframe
                        ...
                        class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" frameborder="0"
                                            ...
                                            <div class="col-sm-6 col-12">
                                                ...
                                                <div class="event-details">
                                                    ...
                                                    <h5 class="text-center mb-0 text-white"><a
                                                            ...
                                                            class="text-white text-decoration-none" dir="ltr">+{{ $vcard->region_code }}
                                                            {{ $vcard->phone }}</a>
                                                    </h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-12">
                                                ...
                                                <div class="event-details">
                                                    ...
                                                    <h5 class="text-center mb-0 text-white"><a
                                                            ...
                                                            class="text-white text-decoration-none" dir="ltr">+{{ $vcard->alternative_region_code }}
