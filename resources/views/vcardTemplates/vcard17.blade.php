        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                    ...
                    <div class="pwa-support d-flex align-items-center justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div>
                            ...
                            <div class="text-end d-flex gap-2">
                                <button id="installPwaBtn" class="pwa-install-button w-50 mb-1 btn btn-gradient">{{__('messages.pwa.install')}} </button>
                                <button class= "pwa-cancel-button w-50 pwa-close btn btn-secondary mb-1">{{__('messages.common.cancel')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="profile-section pt-50 px-30 position-relative">
                ...
                <div class="card flex-sm-row align-items-center">
                    ...
                    <img src="{{ asset('assets/img/vcard17/profile-card-bg.png') }}"  class="h-100 obeject-fit-cover" /></div>
            ...
            !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                    <div class="contact-section pt-50 pb-50 mt-50 px-30 position-relative">
                        ...
                        <div class="row row-gap-20" @if (getLanguage($vcard->
                                    ...
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="text-white fs-14 fw-5" dir="ltr">+{{ $vcard->region_code }}
                                                {{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                class="text-white fs-14 fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}
                ...
                <div class="qr-code-section pt-50 px-30 position-relative">
                    ...
                    <div class="section-heading text-center mb-40">
                        <h2>{{ __('messages.vcard.qr_code') }}</h2>
                            ...
                            <div class="qr-code mx-auto d-flex flex-sm-row flex-column  position-relative z-1 align-items-center" @if (getLanguage($vcard->
                        default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class=" text-center desc-text @if (getLanguage($vcard->
                                            ...
                                            <div class="service-card">
                                             <div class="card-img">
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    <p
                                                        class="card-text description-text text-center text-white {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                    ...
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="card product-card">
                                            ...
                                            <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                                        ...
                                                        <h3 class="product-title text-white fw-5 text-center">{{ $product->name }}</h3>

                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="fw-5 text-gradient amount text-center">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                                    @elseif($product->price)
                                                        <span
                                                            class="fw-5 text-gradient amount text-center">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                    @endif
                                            </div>
                                        </div>
                                    </a>
                                ...
                                @foreach ($vcard->testimonials as $testimonial)
                                    <div>
                                        <div class="card flex-sm-row align-items-center position-relative">
                                            ...
                                            <img src="{{asset('assets/img/vcard17/quote-left-img.svg')}}" loading="lazy"/>
                                            </div>
                                            <div class="quote-img quote-right-img">
                                            <img src="{{asset('assets/img/vcard17/quote-right-img.svg')}}" loading="lazy"/>
                                            </div>
                                            <div class="card-img">
                                    ...
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body">
                                           <h2 class="fs-18 fw-5 text-gradient blog-title">
                                                ...
                                                <a href="{{ $vcardBlogUrl }}" class="read-more d-inline-flex align-items-center justify-content-end gap-2 fs-14" tabindex="0">
                                ...
                                <div class="row row-gap-20 justify-content-center">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="business-hour d-flex align-items-center">
                                            ...
                                            <path d="M20.7971 15.6088C20.9952 15.6088 21.1557 15.4483 21.1557 15.2502C21.1557 15.0522 20.9952 14.8916 20.7971 14.8916C20.599 14.8916 20.4385 15.0522 20.4385 15.2502C20.4385 15.4483 20.599 15.6088 20.7971 15.6088Z" fill="url(#paint3_linear_10208_971)"/>
                                            <path d="M21.9182 16.9536C22.1163 16.9536 22.2768 16.793 22.2768 16.5949C22.2768 16.3969 22.1163 16.2363 21.9182 16.2363C21.7201 16.2363 21.5596 16.3969 21.5596 16.5949C21.5596 16.793 21.7201 16.9536 21.9182 16.9536Z" fill="url(#paint4_linear_10208_971)"/>
                                            <path d="M14.9699 20.9877C15.168 20.9877 15.3286 20.8272 15.3286 20.6291C15.3286 20.4311 15.168 20.2705 14.9699 20.2705C14.7719 20.2705 14.6113 20.4311 14.6113 20.6291C14.6113 20.8272 14.7719 20.9877 14.9699 20.9877Z" fill="url(#paint5_linear_10208_971)"/>
                                            <path d="M16.091 22.333C16.2891 22.333 16.4497 22.1724 16.4497 21.9743C16.4497 21.7763 16.2891 21.6157 16.091 21.6157C15.893 21.6157 15.7324 21.7763 15.7324 21.9743C15.7324 22.1724 15.893 22.333 16.091 22.333Z" fill="url(#paint6_linear_10208_971)"/>
                                            <path d="M21.8069 21.1001C22.0049 21.1001 22.1655 20.9395 22.1655 20.7414C22.1655 20.5434 22.0049 20.3828 21.8069 20.3828C21.6088 20.3828 21.4482 20.5434 21.4482 20.7414C21.4482 20.9395 21.6088 21.1001 21.8069 21.1001Z" fill="url(#paint7_linear_10208_971)"/>
                                            <path d="M20.4612 22.2207C20.6592 22.2207 20.8198 22.0601 20.8198 21.862C20.8198 21.664 20.6592 21.5034 20.4612 21.5034C20.2631 21.5034 20.1025 21.664 20.1025 21.862C20.1025 22.0601 20.2631 22.2207 20.4612 22.2207Z" fill="url(#paint8_linear_10208_971)"/>
                                            <path d="M15.0823 16.6171C15.2803 16.6171 15.4409 16.4566 15.4409 16.2585C15.4409 16.0605 15.2803 15.8999 15.0823 15.8999C14.8842 15.8999 14.7236 16.0605 14.7236 16.2585C14.7236 16.4566 14.8842 16.6171 15.0823 16.6171Z" fill="url(#paint9_linear_10208_971)"/>
                                            <path d="M16.426 15.4965C16.6241 15.4965 16.7846 15.336 16.7846 15.1379C16.7846 14.9399 16.6241 14.7793 16.426 14.7793C16.2279 14.7793 16.0674 14.9399 16.0674 15.1379C16.0674 15.336 16.2279 15.4965 16.426 15.4965Z" fill="url(#paint10_linear_10208_971)"/>
                                            <path d="M20.4389 18.7467C20.4389 18.5562 20.2932 18.4105 20.1026 18.4105H18.7242V15.9002C18.7242 15.7097 18.5785 15.564 18.388 15.564C18.1975 15.564 18.0518 15.7097 18.0518 15.9002V18.7467C18.0518 18.9372 18.1975 19.0829 18.388 19.0829H20.1026C20.2932 19.0829 20.4389 18.9372 20.4389 18.7467Z" fill="url(#paint11_linear_10208_971)"/>
                                            </g>
                                            <defs>
                                            ...
                                            <div>
                                                <div class="text-white fs-14"> {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                                </div>
                                                <div class="text-center text-gradient fs-14 fw-5">{{ $dayTime ?? __('messages.common.closed') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
              ...
              <div class="appointment-section pt-50 px-30 position-relative" @if (getLanguage($vcard->
                default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="section-heading text-center mb-40">
                        ...
                        <div class="vcard-link-card card">
                                <a target="_blank"
                                    ...
                                    class="text-primary link-text fw-5 d-flex justify-content-between align-items-center position-relative text-gradient gap-3" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                    ...
                    <img src="{{ asset('assets/img/vcard17/bg-vector-28.png') }}" alt="bg-vector" />
                        ...
                        <div class="map-box">
                            <div class="map-location d-flex gap-3 align-items-center pb-3 pt-1" @if (getLanguage($vcard->
                                default_language) == 'Arabic') dir="rtl" @endif>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn developer-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
