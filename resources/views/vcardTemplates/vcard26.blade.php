...
<body>
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                        ...
                        <div>
                            ...
                            <div class="text-end d-flex">
                                <button id="installPwaBtn"
                                    class="pwa-install-button w-50 mb-1 bg-primary btn text-white">{{ __('messages.pwa.install') }} </button>
                                <button
            ...
            <div class="profile-section pt-40  overflow-hidden">
                <div class="px-30">
                    <div class="profile-bg">
                        <img src="{{ asset('assets/img/vcard26/profile-bg.png') }}" alt="cart-img" loading="lazy" class="w-100 h-100" />
                    </div>
                    {{--<div class="bg-vector cart-img right-6">
                        <img src="{{ asset('assets/img/vcard26/vector1.svg') }}" alt="cart-img" loading="lazy" />
                    </div>--}}
                    <div class="position-relative">
                        <div class="card d-flex align-items-center justify-content-start gap-sm-5 gap-3 flex-column flex-sm-row bg-transparent    @if($vcard->cover_type == 2) @endif">
                            ...
                            <div class="card-body p-0 text-center text-sm-start">
                                ...
                                <p class="fs-18 text-primary mb-0 company-name p-0 text-decoration-underline fw-5">{{ ucwords($vcard->company) }}</p>
                ...
                <div class="text-black profile-desc text-center fs-14 pt-40 px-30 position-relative">
                    <div class="bg-vector left-10 position-absolute vector-1">
                            <img src="{{ asset('assets/img/vcard26/vector2.svg') }}" alt="profile-desc" loading="lazy" />
                    </div>
                ...
                <div class="social-media d-flex justify-content-center flex-wrap pt-40 position-relative px-30">
                    <div class="bg-vector position-absolute vector-3 text-end">
                        <img src="{{ asset('assets/img/vcard26/vector3.svg') }}" alt="profile-desc" loading="lazy" />
                    </div>
                    <div
                        class="social-icons d-flex justify-content-center text-decoration-none flex-wrap">
                        @foreach (getSocialLink($vcard) as $value)
                            <span
                                class="social-back d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center">
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/img/vcard26/mail.svg') }}" loading="lazy"   class="first-mail" />
                                                </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center">
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/img/vcard26/phone.svg') }}" loading="lazy"   class="first-mail" />
                                                </div>
                                        </div>
                                        <div class="contact-desc">
                                ...
                                <div class="col-sm-6 mb-sm-0 mb-4">
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center">
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/img/vcard26/dob.svg') }}" loading="lazy"   class="first-mail" />
                                                </div>
                                        </div>
                                        <div class="contact-desc">
                                ...
                                <div class="col-sm-6">
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center">
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/img/vcard26/location.svg') }}" loading="lazy"   class="first-mail" />
                                                </div>
                                        </div>
                                        <div class="contact-desc">
                        ...
                        <div class="services">
                            ...
                            @else
                                <div class="row row-gap-20px px-30">
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6">
                                        <div class="service-card d-flex flex-column align-items-center position-relative h-100">
                                                {{--<div class="service-top"></div>--}}
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    class="text-decoration-none img {{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                    target="{{ $service->service_url ? '_blank' : '' }}">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 position-relative px-20">
                        <div class="bg-vector position-absolute vector-5">
                            <img src="{{ asset('assets/img/vcard26/vector6.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20">
                        <div class="bg-vector position-absolute  vector-6 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector7.svg') }}" alt="box-img"  loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                                ...
                                <div>
                                    <div class="testimonial-card text-center">
                                        <div class="quote-img left">
                                            <img src="{{ asset('assets/img/vcard26/quote-img-left-26.png') }}" alt="quote-img" class="ms-auto" loading="lazy" />
                                        </div>
                                        <div class="quote-img right">
                                            <img src="{{ asset('assets/img/vcard26/quote-img-right-26.png') }}" alt="quote-img" class="ms-auto" loading="lazy" />
                                        </div>
                                        <div class="card-body pt-0 pb-4 px-sm-0 px-0">
                                            <div class="d-flex align-items-center justify-content-center gap-4 position-relative max-w-fit mx-auto">
                                                <div class="bg-img">
                                                    <img src="{{ asset('assets/img/vcard26/profile-bg-testimonial.png') }}" alt="">
                                                </div>
                                        ...
                                        <div class="testimonial-description">
                                            <p class="desc text-black fs-14 mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20">
                        <div class="bg-vector position-absolute vector-7">
                            <img src="{{ asset('assets/img/vcard26/vector8.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                        <div class="bg-vector position-absolute vector-8 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector19.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                                        ...
                                        <div class="product-card card h-100">
                                            ...
                                            <div class="product-desc align-items-center">
                                                <div class="text-center d-flex flex-column gap-2">
                                                    ...
                                                    <h4 class="text-center text-black mb-0">
                        ...
                        <div class="text-center view-more mt-4">
                            <a class="fs-6 text-decoration-none d-block btn-primary d-flex align-items-center justify-content-center gap-2"
                                ...
                                <i
                                class="fa-solid fa-arrow-right-long right-arrow-animation text-decoration-none"></i>
                            </a>
                        </div>
                    </div>
                @endif
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30 position-relative">
                        <div class="bg-vector position-absolute vector-9">
                            <img src="{{ asset('assets/img/vcard26/vector9.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 px-20 position-relative">
                        <div class="bg-vector position-absolute vector-10 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector10.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20">
                        <div class="bg-vector position-absolute vector-11">
                            <img src="{{ asset('assets/img/vcard26/vector11.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                            ...
                            @foreach ($vcard->blogs as $blog)
                                ...
                                <div>
                                    <a href="{{ $vcardBlogUrl  }}"
                                        ...
                                        <div class="blog-card card-1"  @if (getLanguage($vcard->
                                                default_language) ==
                                            ...
                                            <div class="blog-content d-flex flex-column justify-content-between">
                                                ...
                                                <div class=" mt-2 d-flex justify-content-end">
                                                    <a href="{{ $vcardBlogUrl  }}"
                                                        ...
                                                        @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl"
                                                        @endif>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative">
                        <div class="bg-vector position-absolute right-6 top-50px">
                            <img src="{{ asset('assets/img/vcard26/vector12.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                        <div class="bg-vector position-absolute vector-12 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector20.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                            <h2 class="mb-0">{{ __('messages.business.business_hours') }}</h2>
                        </div>
                        <div class="business-hours row justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            ...
                            <div class="col-sm-6">
                                <div class="business-box">
                                    ...
                                    <div class="d-flex  justify-content-center gap-2 w-100 business-time">
                                        <div class="fs-14 text-black">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }} :</div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-40">
                    <div class="bg-vector position-absolute vector-13">
                        <img src="{{ asset('assets/img/vcard26/vector13.svg') }}" alt="percentage-img2" loading="lazy" />
                    </div>
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        <div class="bg-vector position-absolute vector-14 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector15.svg') }}" alt="box-img" loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                        ...
                        <div class="contact-form">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="text-center pt-3">
                                    <button class="contact-btn send-btn btn-primary btn w-100"
                                        type="submit">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30">
                    <div class="bg-vector position-absolute vector-17 text-end">
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    ...
                    <div class="bg-vector position-absolute vector-18">
                        <img src="{{ asset('assets/img/vcard26/vector18.png') }}" alt="box-img" loading="lazy" />
                    </div>
                        ...
                        <div class="map-location d-flex gap-2 align-items-center pb-3 pt-1" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            ...
                            <div class="map-iframe">
                                <iframe width="100%" height="300px"
                                    ...
                                    scrolling="no" marginheight="0" marginwidth="0" style="border-radius: 10px;">
                                </iframe>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="add-contact-btn rounded-2"><i
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn retail-bars-btn  @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                    ...
                    <div class="sub-btn d-none">
                            ...
                            @endif
                            @if (empty($vcard->hide_stickybar))
                                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard26-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
        ...
        <div class="position-fixed w-100 h-100 top-0 start-0 bg-animation">
