        ...
        <div
                ...
                <div class="support-banner banner-modal-section w-100 overflow-hidden">
                    ...
                    <div class="">
                        ...
                        <div class="text-center">
                            <a href="{{ $banners->url }}" class="act-now btn btn-secondary" target="_blank" data-turbo="false">{{
            ...
            <div class="profile-section @if ($vcard->cover_type == 2) @endif" @if (getLanguage($vcard->
                ...
                <div class=" position-relative">
                    <div
                        class="position-absolute top-0 profile-img-2 @if (getLanguage($vcard->default_language) == 'Arabic') start-0 @else end-0 @endif">
                        <img src="{{ asset('assets/img/vcard36/vcard36-profile-img-1.png') }}" class="w-100" />
                    </div>
                    <div
                        class="position-absolute top-0 profile-img-1  @if (getLanguage($vcard->default_language) == 'Arabic') end-0 @else start-0 @endif">
                        <img src="{{ asset('assets/img/vcard36/vcard36-profile-img-2.png') }}" class="w-100" />
                    </div>
                ...
                <div class=" fs-14 text-center pt-3 px-30 profile-desc" @if (getLanguage($vcard->default_language) ==
                    'Arabic')
                    dir="rtl" @endif>
            ...
            <div class="contact-section pt-50 px-30 position-relative" @if (getLanguage($vcard->default_language) ==
                ...
                <div class="position-absolute vector-all shape-1">
                    <img src="{{ asset('assets/img/vcard36/shape-2-vcard36.png') }}" class="w-100 h-100 object-fit-cover" />
                </div>
            ...
            <div class="our-services-section pt-50 px-20 position-relative">
                ...
                <div class="position-absolute vector-all shape-5">
                    <img src="{{ asset('assets/img/vcard36/vcard36-section-heading-bg.png') }}" class="w-100 h-100 object-fit-cover" />
                </div>
                <div class="section-heading">
            ...
            <div class="testimonial-section pt-50 px-20 position-relative">
                ...
                <div class="position-absolute vector-all shape-2">
                    <img src="{{ asset('assets/img/vcard36/shape-1-vcard36.png') }}" class="w-100 h-100 object-fit-cover" />
                </div>
                <div class="section-heading">
            ...
            <div class="iframe-section pt-50 px-20 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="left-bg">{{ __('messages.vcard.iframe') }}</h2>
                </div>
            ...
            <div class="contact-us-section pt-50 px-30 position-relative" @if (getLanguage($vcard->default_language) ==
                ...
                <div class="section-heading">
                    <h2 class="right-bg">{{ __('messages.dynamic_vcard.contact_us') }}</h2>
                </div>
                @if (getLanguage($vcard->default_language) != 'Arabic')
            ...
            <div class="create-vcard-section pt-50  position-relative" @if (getLanguage($vcard->default_language)
                == 'Arabic')
                dir="rtl" @endif>
