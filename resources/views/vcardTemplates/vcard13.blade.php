        ...
        <div
                    ...
                    <div class="card-wrapper">
                        ...
                        <div
                            ...
                            <div class="card-body pb-0 px-0 pt-0">
                                <div class="@if($vcard->cover_type == 2) profile-desc-margin @endif profile-name ">
                ...
                <div class="row row-gap-20px">
                    ...
                    <div class="col-sm-6">
                        <div class="contact-box">
                            ...
                            <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                                <div class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                    <img src="{{ asset('assets/img/vcard13/email.svg') }}" />
                                </div>
                            </div>
                            <div class="contact-desc mt-2 text-center">
                                <a href="mailto:{{ $vcard->email }}" class="text-black">{{ $vcard->email }}</a>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-sm-6">
                        <div class="contact-box">
                            ...
                            <div class="contact-desc mt-2 text-center">
                                <a href="mailto:{{ $vcard->alternative_email }}" class="text-black">{{
                    ...
                    <div class="col-sm-6">
                        <div class="contact-box">
                            ...
                            <div class="contact-desc mt-2 text-center">
                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-black"
                        ...
                        <div class="contact-box">
                            ...
                            <div class="contact-desc mt-2 text-center">
                                <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                    class="text-black" dir="ltr">+{{ $vcard->alternative_region_code }}
                    ...
                    <div class="row row-gap-20px">
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box">
                                ...
                                <div class="contact-desc mt-2 text-center">
                                    <a href="mailto:{{ $vcard->email }}" class="text-black">{{ $vcard->email
                                        }}</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="product-card card">
                                        ...
                                        <div
                                            ...
                                            <div class="product-title">
                                                <h3 class="text-black text-center fw-6">{{ $product->name }}</h3>
                                            </div>
                                            <div class="product-amount lh-1 text-center fw-bold">
                                                @if ($product->currency_id && $product->price)
                                                <span class="product-amount text-center fw-bold text-primary">{{
                                                ...
                                                <span class="product-amount  text-center fw-5">{{
            ...
            <div class="testimonial-section pt-50 px-20 position-relative">
                ...
                <div class="testimonial-slider">
                    ...
                    <div>
                        <div class="testimonial-card " @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl"
                            @endif>
                            <div class="profile-img mb-2">
                                <img src="{{ $testimonial->image_url }} " class="img-fluid w-100 h-100 object-fit-cover"
                                    loading="lazy" />
                            </div>
            ...
            <div
                class="blog-section position-relative pt-50 pb-50 px-20 @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                ...
                <div class="blog-slider">
                    ...
                    <?php
                                ...
                                ?>
                    <div class="">
                        <div class="blog-card" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <div class="card-img">
                                <a href="{{ $vcardBlogUrl  }}">
                        ...
                        <div class="col-sm-6">
                            <div class="business-hour-card d-flex gap-2 align-items-center mb-3">
                                ...
                                <div class="d-flex flex-column align-items-start">
                                    ...
                                    <span class="fs-16 fw-5">{{ $dayTime ?? __('messages.common.closed') }}</span>
                                </div>
                            </div>
                        </div>
                        @endforeach
            ...
            <div class="appointment-section section-bg pt-50 px-30 position-relative">
                ...
                <div class="appointment-card p-3">
                    <div class="row d-flex align-items-center justify-content-center    ">
                        <div class="col-12" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="text-center w-100">
                        <button type="submit" class="btn vcard-13-btn w-50 w-sm-100 appointmentAdd p-2 d-none">
                            ...
                            <div class="col-12 mt-2">
                                <div class="d-flex gap-2">
                                    ...
                                    <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                        <span class="text-gray">{{ __('messages.vcard.agree_to_our') }}</span>
                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                            class="text-decoration-none link-info text-decoration-underline text-dark fw-6 ">{!!
            ...
            <div class="px-30 pt-50">
                ...
                <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                    ...
                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                        <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}" class="vcard13-sticky-btn add-contact-btn  d-flex gap-1 justify-content-center ms-0 text-white align-items-center text-decoration-none  justify-content-center
                ...
                <div
                    ...
                    <div class="fixed-btn-section">
                        ...
                        <div
                            class="bars-btn hospital-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                        ...
                        <div class="sub-btn d-none">
                            <div
                                ...
                                @endif
                                @if (empty($vcard->hide_stickybar))
                                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard13-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                ...
                <div class="d-flex justify-content-evenly py-2">
                    ...
                    <a @if (!is_null($vcard->made_by_url)) href="{{ $vcard->made_by_url }}" @endif
                        ...
                        <span class="text-primary fw-5 fs-14">{{ __('messages.made_by') }} {{ $vcard->made_by }}</span>
                    </a>
                    @else
                    <div class="text-center">
                    ...
                    <div>
                        <a class="text-decoration-none text-primary cursor-pointer terms-policies-btn fw-5 fs-14"
                            href="{{ $vcardPrivacyAndTerm }}">{!! __('messages.vcard.term_policy')
                            !!}</a>
                    </div>
                    @endif
                </div>
