...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content vcard w-100 mx-auto content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="vcard__banner w-100 position-relative">
                ...
                @elseif($vcard->cover_type == 1)
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video class="cover-video banner-image {{ $coverClass }}" loop autoplay muted playsinline
            ...
            @if (getLanguage($vcard->default_language) != 'Arabic')
                <div
                    class="vcard__profile d-flex align-items-center px-4 flex-sm-row flex-column @if ($vcard->cover_type == 2) profile-margin @endif">
