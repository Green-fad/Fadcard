        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section position-relative">
                <div class="main-bg-vector pb-3">
                    <img src="{{ asset('assets/img/vcard18/main-bg-vcard18.jpg') }}" alt="images" class="w-100 h-100 object-fit-cover" />
                    </div>
                <div class="card d-flex flex-column flex-sm-row gap-4 gap-sm-5 align-items-center" @if (getLanguage($vcard->
                    ...
                    <div class="card-body p-0">
                        <div class="profile-name d-flex justify-content-center align-items-center align-items-sm-start flex-column">
                            ...
                            <p class="fs-16 text-primary mb-0 text-decoration-underline">{{ ucwords($vcard->company) }}</p>
                                        ...
                                        <div class="d-flex justify-content-center gap-2 flex-column">
                                         ...
                                         <div class="px-40">
                                            @if ($product->currency_id && $product->price)
                                                <span
                                                    class="product-amount text-primary fw-5">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                            @elseif($product->price)
                                                <span
                                                    class="product-amount text-primary fw-5">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                            @endif
                                            </div>
                                        </div>
                                    </div>
                               ...
                               <div>
                                    ...
                                    <div class="testimonial-card d-flex pb-1 flex-column gap-3">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <p class="card-desc fw-4 text-gray-200 mb-2 text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                                        ...
                                        <div class="d-flex gap-2 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                                        <div class="card-img">
                ...
                <div class="business-hour-card row row-gap-20px justify-content-center position-relative">
                    ...
                    <div class="col-sm-6">
                        <div class="business-hour align-items-center">
                            ...
                            <div class="text-start d-flex gap-2"  @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                <span class="text-gray-200">{{ __('messages.business.' .
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                            ...
                                            <div class="form-check mb-3 terms-condition">
                                                ...
                                                <label class="form-check-label" for="privacyPolicyCheckbox">
                                                    ...
                                                    <a href="{{ $vcardPrivacyAndTerm }}"
                                                        target="_blank" class="text-decoration-underline fs-6 text-secondary"
                                    ...
                                    <div class="col-12 text-center mt-3">
                                        <button class="contact-btn send-btn btn btn-primary"
                                            type="submit">
