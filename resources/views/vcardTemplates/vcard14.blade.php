...
<body>
    ...
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="mt-0">
                <div class="pwa-support d-flex align-items-center justify-content-center">
                    <div>
                        <h1 class="text-start text-gradient pwa-heading">{{ __('messages.pwa.add_to_home_screen') }}</h1>
            ...
            <div class="support-banner d-flex align-items-center justify-content-center">
                <button type="button" class="text-start banner-close"><i class="fa-solid fa-xmark text-primary"></i></button>
            ...
            <div class="profile-section main-section px-30 pt-30 pb-30 position-relative overflow-hidden">
                <div class="position-absolute vector-main-1">
                    <img src="{{ asset('assets/img/vcard14/vector-main-1.png') }}" alt="vector-img" class="w-100" />
                </div>
                @if (getLanguage($vcard->default_language) != 'Arabic')
                <div>
                    <div class="card flex-sm-row align-items-center">
                        <div class="card-img me-sm-3">
                            <img src="{{ $vcard->profile_url }}" class="h-100 w-100 object-fit-cover profileImage"
                                loading="lazy" />
                        </div>
            ...
            @if (!empty($vcard->description) || (checkFeature('social_links') && getSocialLink($vcard)) ||
            ...
            <div class="main-section pt-30 pb-30 px-30 position-relative">
                <div class="position-absolute vector-all vector-1">
                    <img src="{{ asset('assets/img/vcard14/vector-1.png') }}" alt="vector-img" class="w-100" />
                </div>
            ...
            <div class="contact-section main-section pt-30 pb-30 px-30 position-relative">
                <div class="position-absolute vector-all vector-2">
                    <img src="{{ asset('assets/img/vcard14/vector-2.png') }}" alt="vector-img" class="w-100" />
                </div>
                    ...
                    <div class="row row-gap-15px">
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="tel:+{{ $vcard->region_code }} {{ $vcard->phone }}" dir="ltr">
                    ...
                    <div class="row row-gap-15px">
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="mailto:{{ $vcard->email }}" class="">{{ $vcard->email }}</a>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="mailto:{{ $vcard->alternative_email }}" class="">{{
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="tel:+{{ $vcard->region_code }} {{ $vcard->phone }}" class="" dir="ltr">+{{
                                        $vcard->region_code }}
                                        {{ $vcard->phone }}</a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                        class="" dir="ltr">+{{ $vcard->alternative_region_code }}
            ...
            <div class="gallery-section main-section pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-3">
                    <img src="{{ asset('assets/img/vcard14/vector-3.png') }}" alt="vector-img" class="w-100" />
                </div>
            ...
            <div class="our-services-section main-section pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-4">
                    <img src="{{ asset('assets/img/vcard14/vector-4.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                ...
                <div class="services">
                                ...
                                <div>
                                    <div class="service-card h-100">
                                        ...
                                        <div class="text-center pt-3">
                                            ...
                                            <p class="card-text description-text text-white {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                    ...
                    @else
                        <div class="px-30">
                            ...
                            @foreach ($vcard->services as $service)
                                <div class="col-sm-6">
                                    <div class="service-card d-flex flex-column h-100" @if (getLanguage($vcard->
                                        ...
                                        <div class="card-body pt-3 px-0 pb-0 text-center">
            ...
            <div class="qr-code-section main-section pt-30 pb-30  px-30 position-relative">
                <div class="position-absolute vector-all vector-5">
                    <img src="{{ asset('assets/img/vcard14/vector-5.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                    <h2 class="text-white mb-0">{{ __('messages.vcard.qr_code') }}</h2>
                </div>
                <div class="qr-code mx-auto position-relative">
                    <div class="d-flex gap-3 align-items-center flex-wrap flex-sm-nowrap justify-content-center text-center text-sm-start"   @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            <div class="product-section main-section pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-6">
                    <img src="{{ asset('assets/img/vcard14/vector-6.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                            ...
                            <div class="">
                                <div class="product-card card">
                                    <div class="product-img card-img">
                                        <img src="{{ $product->product_icon }}" class="object-fit-contain"
                                            loading="lazy" />
                                    </div>
                                    <div class="product-desc card-body">
                                        <div class="d-flex justify-content-center align-items-center flex-column">
                                            ...
                                            <div>
                                                ...
                                                <span class="product-amount text-gradient">{{ $product->currency->currency_icon }}{{
                                                    getSuperAdminSettingValue('hide_decimal_values') == 1 ?
                                                    number_format($product->price, 0) : number_format($product->price,
                                                    2) }}</span>
                                                @elseif($product->price)
                                                <span class="product-amount text-gradient">{{ getUserCurrencyIcon($vcard->user->id) .
                                                    ' ' . $product->price }}</span>
                                                @endif
                ...
                <div class="text-center mt-5">
                    <a class="fs-6 text-decoration-underline btn-primary view-more d-inline-flex gap-2 align-items-center"
                        ...
                        <i class="fa-solid fa-arrow-right right-arrow-animation text-decoration-none"></i></a>
                </div>
            </div>
            ...
            <div class="testimonial-section main-section pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-7">
                    <img src="{{ asset('assets/img/vcard14/vector-7.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                    ...
                    <div class="testimonial-slider">
                        ...
                        <div class="">
                            <div class="testimonial-card position-relative">
                                ...
                                <div class="quote-right-img quote-img d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="text-sm-start text-center">
                                        ...
                                        <div class="d-flex flex-column gap-2 align-items-center justify-content-center"
                                            ...
                                            <div class="profile-img me-3 ms-2">
                                                <img src="{{ $testimonial->image_url }}" class="img-fluid h-100 object-fit-cover"
                                                    loading="lazy" />
                                            </div>
            ...
            <div class="appointment-section main-section pt-30 pb-30 px-30 position-relative">
                <div class="position-absolute vector-all vector-8">
                    <img src="{{ asset('assets/img/vcard14/vector-8.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                ...
                <div class="appointment-card  p-3">
                    <div class="row">
                        <div class="col-12">
                            <div class="position-relative">
                                {{ Form::text('date', null, ['class' => 'date appointment-input text-start',
            ...
            <div class="main-section pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-9">
                    <img src="{{ asset('assets/img/vcard14/vector-9.png') }}" alt="vector-img" class="w-100" />
                </div>
            ...
            <div class="blog-section main-section pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-10">
                    <img src="{{ asset('assets/img/vcard14/vector-10.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                    ...
                    <div>
                        <div class="blog-card">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between text-start">
                                ...
                                <div class="text-end @if (getLanguage($vcard->
                                    default_language) ==
                                    'Arabic') ms-0 @else ms-auto @endif" >
                                    <a href="{{ $vcardBlogUrl  }}" class="text-primary d-inline-block fs-14">
            ...
            <div class="bussiness-hour-section main-section px-30 pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-11">
                    <img src="{{ asset('assets/img/vcard14/vector-11.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                ...
                <div class="position-relative">
                    <div class="row bussiness-hour-card row-gap-15px justify-content-center" @if (getLanguage($vcard->
                        default_language) ==
            ...
            <div class="main-section px-30 pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-12">
                    <img src="{{ asset('assets/img/vcard14/vector-12.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
            ...
            <div class="contact-us-section main-section px-30 pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-13">
                    <img src="{{ asset('assets/img/vcard14/vector-13.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                ...
                <div class="contact-form p-3">
                    <form action="" id="enquiryForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <textarea class="form-control h-100" name="message"
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                        ...
                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                            class="text-decoration-none link-info fs-14 text-primary">{!!
                ...
                <div class="contact-form mb-4 p-3" dir="rtl">
                    <form action="" id="enquiryForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <textarea class="form-control h-100 text-start" name="message"
                                    placeholder="{{ __('messages.form.type_message') }}" rows="3"></textarea>
                            </div>
                            @if (isset($inquiry) && $inquiry == 1)
                            <div class="mb-3 mt-3">
            ...
            <div class="create-vcard-section main-section px-30 pt-30 pb-30 position-relative">
                <div class="position-absolute vector-all vector-14">
                    <img src="{{ asset('assets/img/vcard14/vector-14.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="section-heading">
                    <h2 class="text-white mb-0">{{ __('messages.create_vcard') }}</h2>
                </div>
                <div class="vcard-link-card card">
                    <div class="d-flex align-items-center justify-content-center gap-3" @if (getLanguage($vcard->
                        default_language) == 'Arabic') dir="rtl" @endif>
                        <a href="{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}"
                            class="text-dark link-text" target="_blank">{{ route('register', ['referral-code'
            ...
            <div class="main-section px-30 pt-30 pb-30 position-relative">
                   <div class="position-absolute vector-15 vector-all">
                    <img src="{{ asset('assets/img/vcard14/vector-15.png') }}" alt="vector-img" class="w-100" />
                </div>
                <div class="iframe-card-box">
                    <div class="map-location d-flex gap-2 mb-2 align-items-center py-2" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <iframe width="100%" height="300px" class="overflow-hidden"
                        ...
                        marginheight="0" marginwidth="0" style="border-radius: 10px;"></iframe>
                </div>
            </div>
            @endif
            ...
            <div class="main-section px-30 pt-30 pb-30 position-relative">
                ...
                <div class="iframe-card-box">
                    <div class="map-location d-flex gap-2 mb-2 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div class="location-icon d-flex justify-content-center align-items-center">
                            <img src="{{ asset('assets/img/vcard14/location-icon.svg') }}" />
                        </div>
                        <p class="text-gradient mb-0">{!! ucwords($vcard->location) !!}</p>
            ...
            <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                ...
                <div class="" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    @if ($contactRequest == 1)
                    <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}" class="btn add-contact-btn d-flex justify-content-center ms-0 gap-2 align-items-center  text-decoration-none justify-content-center
                ...
                <div class="fixed-btn-section">
                    ...
                    <div class="sub-btn d-none">
                        <div
                            ...
                            @endif
                            @if (empty($vcard->hide_stickybar))
                            <div class="{{ isset($vcard->whatsapp_share) ? 'vcard14-btn-group' : 'stickyIcon' }}">
            ...
            <div class="d-flex justify-content-evenly main-section pt-3 pb-3 flex-wrap flex-sm-nowrap">
                ...
                <div>
                    <a class="text-decoration-none text-gradient  fw-5 cursor-pointer terms-policies-btn"
                        href="{{ $vcardPrivacyAndTerm }}"><span class="fs-14">{!! __('messages.vcard.term_policy')
                            !!}</span></a>
                </div>
                @endif
            </div>
