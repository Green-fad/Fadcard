                ...
                <div class="head-img position-relative">
                    ...
                    @elseif($vcard->cover_type == 1)
                        @if (strpos($vcard->cover_url, '.mp4') !== false ||
                            ...
                            <video height="400px" class="cover-video banner-image {{ $coverClass }}" loop autoplay
                                muted playsinline alt="background video" id="cover-video">
                                                    ...
                                                    <div class="card  w-100 h-100 bg-transparent border-0 text-light">
                                                        ...
                                                        <div class="product-details mt-3">
                                                            ...
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="text-light">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
