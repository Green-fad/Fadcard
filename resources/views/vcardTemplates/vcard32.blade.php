    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="d-flex justify-content-end position-absolute top-0 end-0 mx-3 language-btn">
                ...
                <div class="profile-section position-relative px-30 pt-40" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="position-absolute top-0 main-bg-vector @if (getLanguage($vcard->default_language) == 'Arabic') start-0 @else end-0 @endif">
                    ...
                    <div class="card flex-sm-row align-items-center flex-column gap-3 gap-sm-4">
                        ...
                        <div class="card-body text-center p-0 @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @else text-sm-start @endif">
                            <div class="profile-name">
                                ...
                                <p class="fs-18 fw-6 text-primary mb-0 text-decoration-underline">{{ ucwords($vcard->company) }}</p>
                ...
                <div class="social-media-section position-relative pt-40 px-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="position-absolute vector-all vector-1">
                        <img src="{{ asset('assets/img/vcard32/vector-bg-1.png') }}" alt="bg-img" class="w-100" />
                        </div>
            ...
            !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                <div class="contact-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-all vector-2">
                        <img src="{{ asset('assets/img/vcard32/vector-bg-2.png') }}" alt="bg-img" class="w-100" />
                        </div>
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-3">
                            <img src="{{ asset('assets/img/vcard32/vector-bg-3.png') }}" alt="bg-img" class="w-100" />
                            </div>
                        <div class="section-heading">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-4">
                            <img src="{{ asset('assets/img/vcard32/vector-bg-4.png') }}" alt="images" class="w-100" />
                            </div>
                        <div class="section-heading">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                ...
                <div class="pt-50 position-relative">
                    ...
                    <img src="{{ asset('assets/img/vcard32/vector-bg-14.png') }}" alt="images" class="w-100" />
                </div>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-5">
                            <img src="{{ asset('assets/img/vcard32/vector-bg-5.png') }}" alt="images" class="w-100" />
                            </div>
                        <div class="section-heading">
                                    ...
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="product-card card">
                                            ...
                                            <div class="card-body product-desc w-100">
                                                <h3 class="text-dark text-center mb-1 product-title">{{ $product->name }}</h3>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-6">
                            <img src="{{ asset('assets/img/vcard32/vector-bg-6.png') }}" alt="images" class="w-100" />
                            </div>
                        <div class="section-heading">
                            ...
                            @foreach ($vcard->testimonials as $testimonial)
                                <div>
                                    <div class="testimonial-card card">
                                        <div class="quote-img">
                            <img src="{{ asset('assets/img/vcard32/quote-img.svg') }}" alt="bg-img" class="h-100" />
                        </div>
                        <div class="d-flex flex-column gap-2 align-items-center">
                                            ...
                                            <h5 class="fw-semibold text-primary text-decoration-underline mb-2 text-center">{{ ucwords($testimonial->name) }}</h5>
                                        </div>
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 position-relative">
                        <div class="position-absolute vector-all vector-7">
                            <img src="{{ asset('assets/img/vcard32/vector-bg-7.png') }}" alt="images" class="w-100" />
                            </div>
                        <div class="section-heading">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-8">
                            <img src="{{ asset('assets/img/vcard32/vector-bg-8.png') }}" alt="images" class="w-100" />
                            </div>
                        <div class="section-heading">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section position-relative pt-50 px-30"
                        ...
                        <div class="position-absolute vector-all vector-9">
                            <img src="{{ asset('assets/img/vcard32/vector-bg-9.png') }}" alt="images" class="w-100" />
                            </div>
                        <div class="section-heading">
                        ...
                        <div class="business-hour-card row justify-content-center position-relative row-gap-20px">
                            ...
                            <div class="text-start d-flex gap-2 justify-content-center align-items-center">
                                <span class="text-gray">{{ __('messages.business.' .
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
               <div class="pt-50 position-relative">
                <div class="position-absolute vector-all vector-15">
                    <img src="{{ asset('assets/img/vcard32/vector-bg-15.png') }}" alt="images" class="w-100" />
                </div>
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section pt-50 position-relative px-20">
                        <div class="position-absolute vector-all vector-10">
                            <img src="{{ asset('assets/img/vcard32/vector-bg-10.png') }}" alt="images" class="w-100" />
                            </div>
                        <div class="section-heading">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-50 px-30 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="position-absolute vector-all vector-11">
                        <img src="{{ asset('assets/img/vcard32/vector-bg-11.png') }}" alt="images" class="w-100" />
                        </div>
                    <div class="section-heading">
                        <h4 class="mb-0">{{ __('messages.contact_us.contact') }}</h4>
                    </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-all vector-12">
                        <img src="{{ asset('assets/img/vcard32/vector-bg-12.png') }}" alt="images" class="w-100" />
                        </div>
                    <div class="content">
                        <div class="section-heading">
            ...
            <div class="pt-50 px-30 position-relative">
                <div class="position-absolute vector-all vector-13">
                    <img src="{{ asset('assets/img/vcard32/vector-bg-13.png') }}" alt="images" class="w-100" />
                    </div>
