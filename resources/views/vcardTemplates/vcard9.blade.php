...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-nine main-content w-100 mx-auto overflow-hidden content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- Pwa support --}}
            ...
            {{-- profile --}}
            <div class="vcard-nine__profile position-relative @if($vcard->cover_type == 2) profile-margin @endif">
            ...
            {{-- profile details --}}
            <div class="vcard-nine__profile-details py-3 px-sm-3 px-2 @if($vcard->cover_type == 2) profile-desc-margin @endif"">
                            ...
                            @if ($vcard->services_slider_view)
                                <div class="row services-slider-view">
                                    @foreach ($vcard->services as $service)
                                        <div>
                                            <div class="service-card my-2 h-100">
