...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/vcard35.css') }}">
    {{-- google font --}}
    ...
    <div class="container p-0">
        <div class="vcard-thirtyfive main-content w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="d-flex align-items-center justify-content-between mb-5 gap-3" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div>
                    ...
                    @foreach ($vcard->products as $product)
                        <div>
                            <div class="product-card card p-1 border-gradient">
                                <div class="p-3 bg-secondary rounded-10">
                                    ...
                                    <div class="card-body px-0 py-0 d-flex flex-column justify-content-center text-center align-items-center">
                                        <div class="product-desc mb-2">
                                            <h3 class="text-black fs-20 fw-5 mb-0 me-2">{{ $product->name }}</h3>
                                        </div>
                                        <p class="fs-14 text-dark mb-2">{{ $product->description }}</p>
                                        <div class="product-amount text-primary fs-20 mb-3">
