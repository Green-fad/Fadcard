        ...
        <div class="vcard-twentyone bg-light main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="d-flex align-items-center gap-2 mb-4 justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div>
                        <h4 class="product-heading mb-0 text-primary">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="text-center">
                        <a class="text-decoration-none btn-gradient d-block btn px-4"
                            href="{{ $vcardUrl }}"
                    ...
                    @foreach ($vcard->products as $product)
                        <div>
                            <div class="product-border mb-3">
                                ...
                                <div class="px-4 py-0 card-body text-center">
                                    <div class="product-desc mb-2">
                                        <h3 class="text-gradient fs-18 fw-5 mb-0">{{ $product->name }}</h3>
                                    </div>
                                    ...
                                    <div class="product-amount text-primary fw-bold fs-20 mb-3">
                                            ...
                                            @elseif($product->price)
                                                <span
                                                    class="fs-18 fw-6 text-primaryproduct-price-{{ $product->id }}">{{ getUserCurrencyIcon($vcard->user->id) }}{{ $product->price }}</span>
                                            @endif
                                        </div>
                                    @if (!empty($product->price))
                                        <div class="text-center">
                                            <button class="btn-gradient btn buy-product"
