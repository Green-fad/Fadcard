...
<body class="vcard-eighteen-body">
    ...
    <div class="container p-0 product-details-page">
        <div class="vcard-eighteen main-content mx-auto w-100 overflow-hidden">

            <div class="vcard-one__product py-3 mt-0">
               <div class="px-30">
                <div class="justify-content-between d-flex align-items-center mb-4" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div>
                        <h4 class="vcard-prodcut-heading fw-500  text-primary mb-0">
                            {{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class=" text-center">
                        <a class="vcard-eighteen-btn btn-primary text-decoration-none d-block"
                            href="{{ $vcardUrl }}"
                        ...
                        <div>
                            <div class="product-card card mb-3">
                                ...
                                <div class="p-0 text-center card-body">
                                    ...
                                    <div class="product-amount text-primary fw-bold fs-20">
                                    ...
                                    @if (!empty($product->price))
                                        <div class="text-center">
                                            <button class="buy-product btn btn-primary mt-2"
