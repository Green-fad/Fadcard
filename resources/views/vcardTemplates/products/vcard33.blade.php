    ...
    <div class="container p-0">
        <div class="vcard-thirtythree main-content w-100 mx-auto content-blur allSection collapse show h-100">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="d-flex align-items-center gap-3 mb-10 justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div>
                        <h4 class="product-heading mb-0">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="text-center">
                        <a class="text-decoration-none btn btn-gradient" href="{{ $vcardUrl }}"
                            role="button">
                            <div class="wave"></div>
                    ...
                    @foreach ($vcard->products as $product)
                        <div>
                            ...
                            <div class="product-card card">
                                ...
                                <div class="card-body pt-4 px-0 pb-0 d-flex flex-column text-center justify-content-center align-items-center">
                                    ...
                                    <div class="product-amount text-primary fs-20">
                                        @if ($product->currency_id && $product->price)
                                            <span
                                                class="fs-20 fw-6 text-primary  product-price-{{ $product->id }}">{{ $product->currency->currency_icon }}{{ number_format($product->price, 2) }}</span>
