    ...
    <div class="container p-0">
        <div class="vcard-thirty main-content w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="d-flex gap-3 align-items-center justify-content-between mb-5" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div>
                        <h4 class="product-heading mb-0">{{ __('messages.vcard.products') }}</h4>
                    </div>
                      <div class="text-center">
                        <a class="back-btn text-decoration-none d-block ms-auto"
                            href="{{ $vcardUrl }}"
                ...
                <div class="product-slider">
                    @foreach ($vcard->products as $product)
                        <div>
                            <div class="product-card card mb-12">
                                <div class="product-img text-center h-100">
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        target="_blank" class="text-decoration-none fs-6">
                                        <div
                                            class=" {{ $product->media->count() < 2 ? 'd-flex justify-content-center' : '' }} product-img-slider overflow-hidden mb-0">
                                ...
                                <div>
                                    <div class="product-desc d-flex flex-column justify-content-center text-center gap-2 align-items-center"
                                        @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                            <h3 class="product-name text-primary fw-5 mb-0">{{ $product->name }}</h3>
                                            <p class="text-white mb-0">{{ $product->description }}</p>
                                        <div class="product-amount fw-bold">
