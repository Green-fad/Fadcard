...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/vcard36.css') }}">
    {{-- google font --}}
    ...
    <div class="container p-0">
        <div class="vcard-thirtysix main-content bg-light  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0">
                <div class="d-flex align-items-center px-30 mb-4 justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div >
                        <h4 class="product-heading mb-0 fs-24">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="text-center">
                        <a class="back-btn d-block text-decoration-none" href="{{ $vcardUrl }}"
                            ...
                            <div class="product-card card  mb-3">
                                ...
                                <div class="px-4 py-0 card-body">
                                    <div class="product-desc mb-2">
                                        <h3 class="text-secondary fs-20 fw-5 mb-0">{{ $product->name }}</h3>
                                    </div>
                                    <p class="fs-14 text-gray-200 mb-3">{{ $product->description }}</p>
                                    <div class="product-amount text-primary fw-bold fs-20 mb-4">
