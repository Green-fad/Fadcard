                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="nfc-details">
                                <div class="modal-body p-0">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-8 image-section">
                                            <div class="text-end">
                                                <button type="button" class="px-3 image-btn-close d-none"
                                        ...
                                        <div class="col-12 col-lg-4 p-8  nfc-form-section">
                                            <div class="d-flex flex-column  h-75 ">
                                                ...
                                                <div id="settings"
                                                    data-value="{{ getSuperAdminSettingValue('hide_decimal_values') }}">
                                                </div>
                                            ...
                                            <div class="h-25 d-flex align-items-end">
                                                <button type="button" class="btn btn-primary text-center buy-now w-100"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#nfcOrderFormModal">{{ __('messages.subscription.buy_now') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-4">
                                            ...
                                            <input type="text" class="form-control" name="company_name"
                                                id="companyName" required value="{{ old('company_name') }}"
                                            ...
                                            <div class="form-group col-sm-6 mb-3">
                                                <div class="mb-3" io-image-input="true">
                                                    <label for="appLogoPreview"
                                                        class="form-label {{ getSuperAdminSettingValue('nfc_logo_required') == 1 ? 'required' : '' }}">{{ __('messages.nfc.logo') }}</label>
                                                    <span data-bs-toggle="tooltip" data-placement="top"
                                                        data-bs-original-title="{{ __('messages.tooltip.app_logo') }}">
                                                        <i
                                                            class="fas fa-question-circle ml-1 mt-1 general-question-mark"></i>
                                                    </span>
                                                    <div class="d-block">
                                                        <div class="image-picker">
                                                            ...
                                                            <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                                ...
                                                                data-bs-original-title="{{ __('messages.tooltip.change_logo') }}">
                                                                <label>
                                                        ...
                                                        <div class="form-text">{{ __('messages.allowed_file_types') }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@pushOnce('scripts')
    ...
    <script>
        let nfcMercadoPagoPublicKey = new MercadoPago("{{ getSelectedPaymentGateway('mp_public_key') }}");
        let options = {
